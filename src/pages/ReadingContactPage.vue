...
const shareUrl = computed(() => {
  ...
  return buildShareUrl('/reading/contact', encodeReadingParams({
...
<template>
  <AppShell>
    ...
    <template v-if="phase === 'intro'">
      ...
      <SectionBlock spacing="sm">
        <div class="intro-notice">
          이 리딩은 연락을 보장하지 않으며, 지금 감정의 흐름을 참고하는 용도입니다. 카드는 방향을 비출 뿐, 선택은 언제나 당신의 것입니다.
        </div>
      </SectionBlock>
    ...
    <template v-else-if="phase === 'result' && drawnCard && result">
      ...
      <SectionBlock spacing="md">
        <PremiumResultCta reading-type="연락 올까" />
      </SectionBlock>
