...
const outputDir = resolve(rootDir, 'content-output/2026-08-24_mon/insta')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(617)}

    <!-- Card area subtle glow -->
    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="42" fill="#F4F8FF" letter-spacing="3" font-weight="300">잠들기 전, 마지막으로 생각나는 사람</text>
...
async function main() {
  console.log('=== 2026-08-24 참여형 shortform ===')
