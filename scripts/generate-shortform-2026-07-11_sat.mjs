/**
 * 참여형 shortform(토 릴스) 2026-07-11 (7/11 토릴 참여형(시점+변화동사))
 * 훅: 이번 주말, 애매하던 그 사람이, / 마음을 정할까요?
 */
...
const outputDir = resolve(rootDir, 'content-output/2026-07-11_sat/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(711)}

    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="378" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="46" fill="#F4F8FF" letter-spacing="2" font-weight="300">이번 주말, 애매하던 그 사람이,</text>
      <text x="540" y="458" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">마음을 정할까요?</text>
    </g>
...
async function main() {
  console.log('=== 7/11 토릴 참여형(시점+변화동사) ===')
