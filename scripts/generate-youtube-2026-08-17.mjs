...
const WEEK = [
  {
    date: '2026-08-17_mon', type: 'single', seed: 817,
    hook: ['헤어진 건 한참 전인데', '마음만 아직 그날에 남아 있을 때'],
    cards: [
      {
        no: 1, numGlyph: '', file: 'mcards/cups/Five of Cups.png',
        nameKo: '컵의 5', nameEn: 'Five of Cups', keywords: '상실 · 후회 · 슬픔',
        reveal: ['쏟아진 것만 보이고', '남은 것은 등 뒤에 있어요'],
        pages: [
          ['지금 내 마음', [
            '끝난 건 머리로 다 알고 있어요.',
            '그런데 마음은 아직 그 자리에 서 있어요.',
            '좋았던 장면만 자꾸 선명하게 떠올라요.',
            '누구에게 말하기도 애매한 시기가 길어져요.',
            '괜찮은 척하는 게 더 지치게 만들어요.',
            '언제쯤 가벼워질지 짐작이 안 돼요.',
          ]],
          ['카드의 메시지', [
            'Five of Cups는 쏟아진 잔 세 개를 보는 자리예요.',
            '하지만 등 뒤에는 두 잔이 그대로 서 있어요.',
            '카드는 잃은 게 없다고 말하지 않아요.',
            '다 잃은 건 아니라고 말할 뿐이에요.',
            '지금은 슬픔이 잘못된 게 아니에요.',
            '시선이 한쪽만 향해 있는 게 힘든 거예요.',
          ]],
          ['러브타로의 조언', [
            '억지로 잊으려 애쓰지 않아도 돼요.',
            '애도에도 충분한 시간이 필요해요.',
            '다만 하루에 한 번은 뒤를 돌아봐 주세요.',
            '아직 남아 있는 사람과 자리가 보일 거예요.',
            '고개를 돌리는 데도 연습이 필요해요.',
            '그 방향에서 다음 이야기가 시작돼요.',
          ]],
        ],
  ...
  {
    date: '2026-08-18_tue', type: 'pick', seed: 818,
    hook: ['이번 주, 조용하던 휴대폰이', '그 사람 이름으로 울릴까요?'],
    cards: [
      {
        no: 1, numGlyph: '①', file: 'cards-png/lovers.png',
        nameKo: '연인', nameEn: 'The Lovers', keywords: '선택 · 관계 · 조화',
        reveal: ['할지 말지가 아니라', '어떻게 할지를 고르는 중이에요'],
        pages: [
          ['그 사람의 속마음', [
            '이 사람 안에서 지금 정리가 진행되고 있어요.',
            '연락할지 말지를 고민하는 단계는 지났어요.',
            '어떤 마음으로 말을 걸지를 고르는 중이에요.',
            '연인 카드는 가벼운 접근을 잘 택하지 않아요.',
            '그래서 오면 짧은 인사로 끝나지 않아요.',
            '한 번에 여러 말을 담아 올 가능성이 있어요.',
          ]],
          ['러브타로의 조언', [
            '먼저 재촉하지 않아도 되는 흐름이에요.',
            '이쪽에서 앞당기면 말이 얕아질 수 있어요.',
            '기다리는 동안 답할 말을 정리해두세요.',
            '연인 카드는 선택을 두 사람 몫으로 봐요.',
            '받는 쪽의 마음도 정해져 있어야 해요.',
            '무엇을 원하는지부터 스스로 확인해보세요.',
          ]],
        ],
      },
      {
        no: 2, numGlyph: '②', file: 'mcards/swords/Five of Swords.png',
        nameKo: '소드의 5', nameEn: 'Five of Swords', keywords: '갈등 · 충돌 · 상처를 남기는 승리',
        reveal: ['연락보다 먼저', '지난 일이 따라와요'],
        pages: [
          ['그 사람의 속마음', [
            '이 사람도 연락을 생각하고는 있어요.',
            '다만 지난 일이 정리되지 않은 채예요.',
            'Five of Swords는 이겨도 남는 게 없는 자리예요.',
            '말을 꺼내면 다툼이 될까 봐 미루고 있어요.',
            '연락이 와도 첫 대화가 편하지는 않을 수 있어요.',
            '누가 옳았는지를 먼저 확인하려 들 수 있어요.',
          ]],
          ['러브타로의 조언', [
            '옳고 그름을 가리는 대화는 남는 게 적어요.',
            '이기는 쪽이 정해져도 관계는 줄어들어요.',
            '지금은 설명보다 분위기를 지키는 게 먼저예요.',
            '한 발 물러서는 쪽이 결국 관계를 지켜요.',
            '지지 않으려는 마음을 잠시 내려놓아 보세요.',
            '그때 실제로 하고 싶던 말이 보일 거예요.',
          ]],
        ],
      },
      {
        no: 3, numGlyph: '③', file: 'mcards/cups/Nine of Cups.png',
        nameKo: '컵의 9', nameEn: 'Nine of Cups', keywords: '소원 성취 · 만족 · 행복',
        reveal: ['바라던 연락이', '실제로 도착해요'],
        pages: [
          ['그 사람의 속마음', [
            '이 사람 마음은 이미 이쪽을 향해 있어요.',
            'Nine of Cups는 바람이 이루어지는 자리예요.',
            '연락하고 싶다는 생각을 여러 번 했어요.',
            '다만 용기를 내는 데 며칠이 걸릴 수 있어요.',
            '첫 문장을 고르는 데 시간을 쓰고 있어요.',
            '그래서 늦어질 뿐 오지 않는 건 아니에요.',
          ]],
          ['러브타로의 조언', [
            '기다리는 동안 마음을 다 쓰지 마세요.',
            '확인하는 횟수가 늘수록 더 길게 느껴져요.',
            '이 카드는 재촉하지 않아도 되는 자리예요.',
            '올 것은 오는 흐름으로 놓여 있어요.',
            '그동안 나에게 좋은 것을 하나씩 해주세요.',
            '연락이 왔을 때 더 편하게 받을 수 있어요.',
          ]],
        ],
      },
    ],
  ...
  {
    date: '2026-08-19_wed', type: 'pick', seed: 819,
    hook: ['오늘 하루도 눈에 밟힌 사람', '그 사람 기준으로 하나만 골라보세요'],
    cards: [
      {
        no: 1, numGlyph: '①', file: 'cards-png/star.png',
        nameKo: '별', nameEn: 'The Star', keywords: '희망 · 치유 · 믿음',
        reveal: ['식은 게 아니라', '조용해진 자리예요'],
        pages: [
          ['그 사람의 속마음', [
            '이 사람도 이쪽을 조용한 자리에 두고 있어요.',
            '표현이 줄었다고 마음이 식은 건 아니에요.',
            '별 카드는 회복이 진행되는 시기를 말해요.',
            '지난 관계에서 지친 부분을 추스르는 중이에요.',
            '지금은 크게 다가올 힘이 남아 있지 않아요.',
            '대신 천천히 돌아오는 방향에 서 있어요.',
          ]],
          ['러브타로의 조언', [
            '조급하게 확인하려 들지 않아도 돼요.',
            '별 카드는 서두르면 흐려지는 자리예요.',
            '지금은 신호를 세는 대신 두는 게 나아요.',
            '가벼운 안부 정도는 충분히 닿아요.',
            '기대를 크게 걸지 않으면 오래 갈 수 있어요.',
            '회복이 끝나면 표현도 함께 돌아와요.',
          ]],
        ],
      },
      {
        no: 2, numGlyph: '②', file: 'mcards/pentacles/Five of Pentacles.png',
        nameKo: '펜타클의 5', nameEn: 'Five of Pentacles', keywords: '결핍 · 고난 · 외로움',
        reveal: ['문 앞까지 와놓고', '두드리지 못하고 있어요'],
        pages: [
          ['그 사람의 속마음', [
            '이 사람은 지금 자기 상황에 묶여 있어요.',
            '마음이 없어서 멀어진 게 아니에요.',
            'Five of Pentacles는 여유가 없는 자리예요.',
            '일이든 감정이든 감당할 여력이 부족해요.',
            '그런 상태로 다가가는 걸 미안해하고 있어요.',
            '문 앞까지 와서 돌아서는 마음에 가까워요.',
          ]],
          ['러브타로의 조언', [
            '연락이 없다고 마음을 단정하지 마세요.',
            '이 카드는 상대의 사정을 먼저 봐야 해요.',
            '무겁지 않은 안부 한 줄이면 충분해요.',
            '설명을 요구하면 더 멀어질 수 있어요.',
            '기댈 수 있는 자리로 남아 있어 주세요.',
            '여유가 돌아오면 먼저 문을 두드려요.',
          ]],
        ],
      },
      {
        no: 3, numGlyph: '③', file: 'mcards/wands/Queen of Wands.png',
        nameKo: '완드의 여왕', nameEn: 'Queen of Wands', keywords: '자신감 · 카리스마 · 따뜻한 열정',
        reveal: ['온기는 있는데', '먼저를 미루고 있어요'],
        pages: [
          ['그 사람의 속마음', [
            '이 사람 안에 분명한 온기가 있어요.',
            'Queen of Wands는 마음을 숨기지 않는 카드예요.',
            '다만 먼저 움직이는 쪽을 미루고 있어요.',
            '이쪽 마음을 한 번은 확인하고 싶어 해요.',
            '거절당하는 것보다 애매한 걸 싫어해요.',
            '신호가 오면 반응은 빠르게 돌아와요.',
          ]],
          ['러브타로의 조언', [
            '이 자리에서는 한 걸음이 크게 작용해요.',
            '먼저 연락한다고 지는 관계가 아니에요.',
            '가볍고 분명한 한마디가 가장 잘 통해요.',
            '돌려 말하면 오히려 신호를 놓쳐요.',
            '이 카드는 솔직한 쪽에 힘을 실어줘요.',
            '한 걸음 뒤의 속도는 훨씬 빨라져요.',
          ]],
        ],
      },
  ...
  {
    date: '2026-08-20_thu', type: 'pick', seed: 820,
    hook: ['매달릴까,', '돌아설까?'],
    cards: [
      {
        no: 1, numGlyph: '①', file: 'cards-png/fool.png',
        nameKo: '바보', nameEn: 'The Fool', keywords: '새로운 시작 · 가능성 · 순수함',
        reveal: ['끝낼 때가 아니라', '새로 시작할 때예요'],
        pages: [
          ['그 사람의 속마음', [
            '이 관계는 아직 닫힌 상태가 아니에요.',
            '바보 카드는 다시 여는 자리를 말해요.',
            '다만 지난 방식으로는 이어지지 않아요.',
            '서로 익숙해진 패턴이 관계를 멈춰 세웠어요.',
            '상대도 다른 방식을 기다리고 있어요.',
            '먼저 달라지는 쪽에 길이 열려요.',
          ]],
          ['러브타로의 조언', [
            '계산을 앞세우면 이 카드와 맞지 않아요.',
            '재는 마음을 내려놓는 쪽이 유리해요.',
            '완벽한 타이밍을 기다릴 필요는 없어요.',
            '바보 카드는 준비보다 발걸음을 말해요.',
            '작게라도 다른 방식을 하나 시도해보세요.',
            '어떤 시작이 될지는 걸어봐야 알아요.',
          ]],
        ],
      },
      {
        no: 2, numGlyph: '②', file: 'mcards/swords/Ten of Swords.png',
        nameKo: '소드의 10', nameEn: 'Ten of Swords', keywords: '끝 · 배신 · 완전한 마무리',
        reveal: ['이 형태의 관계는', '이미 한 번 끝나 있어요'],
        pages: [
          ['그 사람의 속마음', [
            '지금 형태의 관계는 이미 지나 있어요.',
            'Ten of Swords는 확실한 마무리를 말해요.',
            '상대 안에서는 정리가 끝난 상태예요.',
            '표현을 안 했을 뿐 되돌릴 생각은 적어요.',
            '매달릴수록 같은 자리를 다시 누르게 돼요.',
            '기다림이 길어질수록 소모만 커져요.',
          ]],
          ['러브타로의 조언', [
            '돌아서는 건 지는 게 아니에요.',
            '자신을 지키는 선택에 가까워요.',
            '이 카드는 바닥이 곧 끝이라고 말해요.',
            '더 나빠질 것이 남아 있지 않다는 뜻이에요.',
            '끝을 인정하면 회복이 그날부터 시작돼요.',
            '다음 이야기는 그 뒤에 놓여 있어요.',
          ]],
        ],
      },
      {
        no: 3, numGlyph: '③', file: 'mcards/cups/Queen of Cups.png',
        nameKo: '컵의 여왕', nameEn: 'Queen of Cups', keywords: '공감 · 직관 · 깊은 감정',
        reveal: ['답을 정하기 전에', '마음부터 돌봐야 해요'],
        pages: [
          ['그 사람의 속마음', [
            '지금은 결론을 낼 시점이 아니에요.',
            'Queen of Cups는 감정이 앞선 자리를 말해요.',
            '지금 정하면 마음이 대신 대답해요.',
            '며칠 뒤에는 다르게 보일 가능성이 커요.',
            '상대도 아직 확실한 방향을 못 정했어요.',
            '두 사람 다 감정에 흔들리는 구간이에요.',
          ]],
          ['러브타로의 조언', [
            '며칠만 거리를 두고 지켜보세요.',
            '이 카드는 직관이 살아나는 시간을 말해요.',
            '지쳐 있을 때의 판단은 오래 가지 않아요.',
            '잠과 식사부터 챙기는 게 먼저예요.',
            '회복되면 답은 저절로 선명해져요.',
            '그때 고른 방향이 오래 갑니다.',
          ]],
  ...
  {
    date: '2026-08-21_fri', type: 'single', seed: 821,
    hook: ['마음 다 준 것처럼 굴다가도', '확답 앞에선 멈칫하는 사람'],
    cards: [
      {
        no: 1, numGlyph: '', file: 'mcards/swords/Two of Swords.png',
        nameKo: '소드의 2', nameEn: 'Two of Swords', keywords: '결정 회피 · 균형 · 긴장',
        reveal: ['싫어서 멈춘 게 아니라', '고르지 못해서 멈춘 자리예요'],
        pages: [
          ['지금 내 마음', [
            '다정할 때는 다 준 사람처럼 느껴져요.',
            '그런데 확실하게 물으면 조용해져요.',
            '내가 오해한 건지 몇 번씩 되짚게 돼요.',
            '기대해도 되는지 아닌지 알 수가 없어요.',
            '물어보자니 분위기가 깨질까 봐 망설여요.',
            '그 애매함이 제일 사람을 지치게 해요.',
          ]],
          ['카드의 메시지', [
            'Two of Swords는 눈을 가린 채 앉은 자리예요.',
            '두 자루를 가슴에 안고 어느 쪽도 못 놔요.',
            '마음이 없어서 멈춘 게 아니에요.',
            '고르는 순간 하나를 잃는 걸 알기 때문이에요.',
            '재촉이 들어오면 눈가리개가 더 단단해져요.',
            '이 카드는 시간이 필요한 자리를 말해요.',
          ]],
          ['러브타로의 조언', [
            '답을 받아내는 것보다 안심이 먼저예요.',
            '몰아세우면 결정이 아니라 회피가 나와요.',
            '무엇을 두려워하는지 물어보는 편이 나아요.',
            '다만 기다리는 기한은 스스로 정해두세요.',
            '무한정 기다리면 이쪽이 먼저 소모돼요.',
            '눈가리개는 결국 본인이 풀어야 해요.',
          ]],
        ],
      },
  ...
  {
    date: '2026-08-22_sat', type: 'pick', seed: 822,
    hook: ['두 사람 사이 마음의 무게', '지금 어느 쪽에 실려 있을까?'],
    cards: [
      {
        no: 1, numGlyph: '①', file: 'cards-png/hierophant.png',
        nameKo: '교황', nameEn: 'The Hierophant', keywords: '전통 · 신뢰 · 가르침',
        reveal: ['무게는 비슷한데', '형태를 원하고 있어요'],
        pages: [
          ['그 사람의 속마음', [
            '지금 두 사람의 무게는 비슷하게 놓여 있어요.',
            '어느 쪽이 더 좋아하는 구도는 아니에요.',
            '교황 카드는 관계의 형태를 중요하게 봐요.',
            '이 사람은 확실한 자리를 만들고 싶어 해요.',
            '가벼운 사이로 두고 싶지 않다는 뜻이에요.',
            '그래서 오히려 말을 아끼고 있어요.',
          ]],
          ['러브타로의 조언', [
            '지금은 속도보다 방향이 중요한 시기예요.',
            '이 카드는 급하게 가는 관계를 싫어해요.',
            '약속이나 기준을 함께 정해두면 좋아요.',
            '애매한 채로 두면 상대가 먼저 지쳐요.',
            '관계를 어떻게 부를지부터 이야기해보세요.',
            '형태가 생기면 무게도 안정돼요.',
          ]],
        ],
      },
      {
        no: 2, numGlyph: '②', file: 'mcards/cups/King of Cups.png',
        nameKo: '컵의 킹', nameEn: 'King of Cups', keywords: '감정적 성숙 · 안정 · 이해',
        reveal: ['무게는', '그 사람 쪽에 실려 있어요'],
        pages: [
          ['그 사람의 속마음', [
            '무게는 이 사람 쪽에 더 실려 있어요.',
            'King of Cups는 감정을 오래 담아두는 카드예요.',
            '표현이 잔잔해서 덜 좋아하는 것처럼 보였어요.',
            '실제로는 이미 깊은 자리까지 와 있어요.',
            '요란하게 드러내는 방식을 택하지 않아요.',
            '그래서 티가 늦게 나는 사람이에요.',
          ]],
          ['러브타로의 조언', [
            '표현의 크기로 마음을 재지 마세요.',
            '이 카드는 조용한 방식이 진심인 자리예요.',
            '작은 배려가 반복되는지를 보세요.',
            '그게 이 사람의 언어에 가까워요.',
            '이쪽에서 먼저 표현해주면 크게 열려요.',
            '기다려온 시간이 생각보다 길 수 있어요.',
          ]],
        ],
      },
      {
        no: 3, numGlyph: '③', file: 'mcards/swords/Eight of Swords.png',
        nameKo: '소드의 8', nameEn: 'Eight of Swords', keywords: '속박 · 제한 · 스스로 만든 감옥',
        reveal: ['무게는', '내 쪽으로 기울어 있어요'],
        pages: [
          ['그 사람의 속마음', [
            '지금은 이쪽으로 무게가 기울어 있어요.',
            'Eight of Swords는 스스로 묶인 자리예요.',
            '혼자 생각하는 시간이 실제 관계보다 길어요.',
            '상대는 그만큼 고민하고 있지 않아요.',
            '나쁜 뜻이라기보다 상황을 모르는 쪽이에요.',
            '오해의 대부분이 확인되지 않은 추측이에요.',
          ]],
          ['러브타로의 조언', [
            '이 카드의 밧줄은 느슨하게 묶여 있어요.',
            '직접 물어보면 생각보다 쉽게 풀려요.',
            '머릿속 시나리오를 늘리지 마세요.',
            '확인 한 번이 몇 주를 아껴줘요.',
            '두려운 건 답이 아니라 모르는 상태예요.',
            '한마디를 꺼내는 순간부터 가벼워져요.',
          ]],
        ],
      },
  ...
  {
    date: '2026-08-23_sun', type: 'pick', seed: 823,
    hook: ['다음 주, 그 사람 마음에', '볕이 들까요?'],
    cards: [
      {
        no: 1, numGlyph: '①', file: 'cards-png/sun.png',
        nameKo: '태양', nameEn: 'The Sun', keywords: '기쁨 · 성공 · 활력',
        reveal: ['주 초반, 흐렸던 자리에', '볕이 들 수 있어요'],
        pages: [
          ['그 사람의 속마음', [
            '다음 주 초반에 분위기가 밝아질 수 있어요.',
            '태양 카드는 가려졌던 게 드러나는 자리예요.',
            '오해였던 부분이 자연스럽게 풀려요.',
            '상대도 마음을 감출 이유가 줄어들어요.',
            '표정이나 말투에서 먼저 달라져요.',
            '숨은 뜻을 읽지 않아도 되는 구간이에요.',
          ]],
          ['러브타로의 조언', [
            '이 카드는 먼저 웃는 쪽에 힘을 실어줘요.',
            '무겁게 접근하면 흐름이 늦어져요.',
            '가볍고 밝은 연락이 가장 잘 통해요.',
            '지난 일을 다시 꺼낼 필요는 없어요.',
            '지금 온기를 키우는 게 더 중요해요.',
      ...
      {
        no: 2, numGlyph: '②', file: 'mcards/swords/Page of Swords.png',
        nameKo: '소드의 페이지', nameEn: 'Page of Swords', keywords: '호기심 · 경계심 · 새로운 소식',
        reveal: ['주 중반, 예상 밖의 소식이', '들어올 수 있어요'],
        pages: [
          ['그 사람의 속마음', [
            '주 중반에 예상 밖의 소식이 들어와요.',
            'Page of Swords는 새로운 정보의 카드예요.',
            '짧은 메시지 하나가 흐름을 바꿔요.',
            '오래 연락 없던 쪽일 가능성도 있어요.',
            '내용보다 타이밍이 더 중요한 소식이에요.',
            '좋고 나쁨은 아직 정해지지 않았어요.',
          ]],
          ['러브타로의 조언', [
            '받자마자 해석하지 마세요.',
            '이 카드는 성급한 반응에 약해요.',
            '한 박자 두고 답하는 편이 훨씬 나아요.',
            '되묻는 것도 좋은 방법이에요.',
            '확인하지 않은 추측을 옮기지 마세요.',
            '천천히 볼수록 정확하게 읽혀요.',
          ]],
      ...
      {
        no: 3, numGlyph: '③', file: 'mcards/cups/Three of Cups.png',
        nameKo: '컵의 3', nameEn: 'Three of Cups', keywords: '축하 · 기쁨 · 함께하는 행복',
        reveal: ['주 후반, 함께 웃는 자리가', '생길 수 있어요'],
        pages: [
          ['그 사람의 속마음', [
            '주 후반에 함께 웃는 자리가 생겨요.',
            'Three of Cups는 사람들 사이의 카드예요.',
            '둘만의 만남보다 여럿이 모이는 자리예요.',
            '편한 분위기에서 거리가 빠르게 줄어요.',
            '상대의 다른 모습을 보게 될 수 있어요.',
            '긴장이 풀리면서 대화가 늘어나요.',
          ]],
          ['러브타로의 조언', [
            '초대가 오면 미루지 말고 가보세요.',
