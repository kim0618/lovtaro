...
const outputDir = resolve(rootDir, 'content-output/2026-07-12_sun/shortform')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'hermit', imageSrc: 'public/images/cards-png/hermit.png',
    ...
    hook: ['주 초반, 잠시 거리를 두며', '서로 마음을 가다듬어요'] },
  { num: '②', slug: 'nine-of-wands', imageSrc: 'public/images/mcards/wands/Nine of Wands.png',
    nameKr: '완드의 9', nameEn: 'Nine of Wands', keywords: '회복력 · 경계 · 마지막 힘',
    hook: ['주 중반, 지친 마음에도', '한 번 더 마음을 내봐요'] },
  { num: '③', slug: 'two-of-pentacles', imageSrc: 'public/images/mcards/pentacles/Two of Pentacles.png',
    nameKr: '펜타클의 2', nameEn: 'Two of Pentacles', keywords: '균형 · 조율 · 유연함',
    hook: ['주 후반, 흔들리던 사이에', '조금씩 균형이 잡혀요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="420" text-anchor="middle" font-family="${KO_STACK}" font-size="50" fill="#F4F8FF" letter-spacing="1" font-weight="300">다음 주, 흐릿하던 그 사람 마음이</text>
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="56" fill="#F4F8FF" letter-spacing="2" font-weight="300">또렷해질까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-07-12 Sunday Tarot Preview - The Hermit/Nine of Wands/Two of Pentacles ===')
