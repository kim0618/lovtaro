...
const outputDir = resolve(rootDir, 'content-output/2026-08-09_sun/insta')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'temperance', imageSrc: 'public/images/cards-png/temperance.png',
    nameKr: '절제', nameEn: 'Temperance', keywords: '조화 · 균형 · 인내',
    hook: ['주 초반, 어긋나던 속도가', '조금씩 맞춰져요'] },
  { num: '②', slug: 'knight-of-wands', imageSrc: 'public/images/mcards/wands/Knight of Wands.png',
    nameKr: '완드의 나이트', nameEn: 'Knight of Wands', keywords: '추진 · 행동 · 속도',
    hook: ['주 중반, 한쪽이 먼저', '움직이기 시작해요'] },
  { num: '③', slug: 'king-of-swords', imageSrc: 'public/images/mcards/swords/King of Swords.png',
    nameKr: '소드의 킹', nameEn: 'King of Swords', keywords: '판단 · 결론 · 명확함',
    hook: ['주 후반, 미뤄두던 것에', '분명한 답이 나와요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="420" text-anchor="middle" font-family="${KO_STACK}" font-size="50" fill="#F4F8FF" letter-spacing="1" font-weight="300">다음 주, 어긋나기만 하던 타이밍이</text>
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="56" fill="#F4F8FF" letter-spacing="2" font-weight="300">맞아떨어질까요?</text>
    </g>
