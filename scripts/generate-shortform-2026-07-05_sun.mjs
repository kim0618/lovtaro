...
const outputDir = resolve(rootDir, 'content-output/2026-07-05_sun/shortform')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'star', imageSrc: 'public/images/cards-png/star.png',
    nameKr: '별', nameEn: 'The Star', keywords: '희망 · 치유 · 믿음',
    hook: ['주 초반, 흐려졌던 마음에', '다시 빛이 들어와요'] },
  { num: '②', slug: 'ace-of-swords', imageSrc: 'public/images/mcards/swords/Ace of Swords.png',
    nameKr: '소드의 에이스', nameEn: 'Ace of Swords', keywords: '명확함 · 진실 · 결단',
    hook: ['주 중반, 애매하던 마음이', '또렷하게 정리돼요'] },
  { num: '③', slug: 'two-of-cups', imageSrc: 'public/images/mcards/cups/Two of Cups.png',
    nameKr: '컵의 2', nameEn: 'Two of Cups', keywords: '연결 · 교감 · 마주봄',
    hook: ['주 후반, 두 마음이', '다시 마주 보게 돼요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="420" text-anchor="middle" font-family="${KO_STACK}" font-size="50" fill="#F4F8FF" letter-spacing="1" font-weight="300">다음 주, 어정쩡하던 사이가</text>
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="56" fill="#F4F8FF" letter-spacing="2" font-weight="300">분명하게 정리될까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-07-05 Sunday Tarot Preview - The Star/Ace of Swords/Two of Cups ===')
  mkdirSync(outputDir, { recursive: true })
  await scene01()                                  // 훅 도입
  await scene02()                                  // 선택 유도
  await revealScene(CARDS[0], 122, 'scene03.png')  // 1번 공개 (The Star)
  await revealScene(CARDS[1], 222, 'scene04.png')  // 2번 공개 (Ace of Swords)
  await revealScene(CARDS[2], 322, 'scene05.png')  // 3번 공개 (Two of Cups)
