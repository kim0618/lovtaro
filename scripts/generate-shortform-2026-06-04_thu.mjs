/**
 * 참여형 shortform 2026-06-04_thu (달 / Knight of Pentacles / Five of Cups)
 * 훅: 붙잡을까, / 놓아줄까?
 */
...
const outputDir = resolve(rootDir, 'content-output/2026-06-04_thu/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(64)}

    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="375" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="58" fill="#F4F8FF" letter-spacing="4" font-weight="300">붙잡을까,</text>
      <text x="540" y="460" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="58" fill="#F4F8FF" letter-spacing="4" font-weight="300">놓아줄까?</text>
    </g>
...
async function main() {
  console.log('=== 2026-06-04 참여형 shortform 이미지 생성 ===')
