/**
 * 참여형 shortform 2026-06-02_tue (별 / 심판 / 매달린 사람)
 * 훅: 그 사람 관심, / 지금 어디쯤 와 있을까?
 */
...
const outputDir = resolve(rootDir, 'content-output/2026-06-02_tue/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(62)}

    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">그 사람 관심,</text>
...
async function main() {
  console.log('=== 2026-06-02 참여형 shortform 이미지 생성 ===')
