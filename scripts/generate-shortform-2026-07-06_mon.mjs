/**
 * 참여형 shortform 2026-07-06 (7/6 월 참여형(엔진: 강한 몰입 한정))
 * 훅: 요즘 계속 마음에 맴도는 사람 기준으로, / 하나만 골라보세요
 */
...
const outputDir = resolve(rootDir, 'content-output/2026-07-06_mon/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(706)}

    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="378" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" fill="#F4F8FF" letter-spacing="1" font-weight="300">요즘 계속 마음에 맴도는 사람 기준으로,</text>
      <text x="540" y="458" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">하나만 골라보세요</text>
    </g>
...
async function main() {
  console.log('=== 7/6 월 참여형(엔진: 강한 몰입 한정) ===')
