/**
 * carousel 2026-05-30_sat (The Moon 커버)
 * 훅: 흐릿한 마음 앞에서, / 절대 먼저 결정하면 안 되는 3가지
 * 본문: Eight of Swords, Seven of Cups, Three of Swords
 */
...
const outputDir = resolve(rootDir, 'content-output/2026-05-30_sat/carousel')
...
async function slide01() {
  ...
  if (masked) {
    ...
    <text x="540" y="1085" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">흐릿한 마음 앞에서,</text>
    <text x="540" y="1145" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">절대 먼저 결정하면 안 되는</text>
    <text x="540" y="1205" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">3가지</text>
...
async function slide05() {
  ...
  if (masked) {
    ...
    <text x="540" y="1105" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="24" fill="rgba(210,200,250,0.65)" text-anchor="middle">마음이 흐려질 때 다시 꺼내보세요</text>
    <line x1="400" y1="1140" x2="680" y2="1140" stroke="rgba(180,170,230,0.12)" stroke-width="1"/>
    <text x="540" y="1180" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="22" fill="rgba(200,190,240,0.5)" text-anchor="middle">흔들리는 친구에게도</text>
...
async function main() {
  console.log('=== 2026-05-30 carousel (The Moon) 이미지 생성 ===')
  mkdirSync(outputDir, { recursive: true })

  await slide01()

  await contentSlide('eight-of-swords',
    'Eight of Swords', '서둘러 결론 짓지 않기',
    '흐려진 시야 속에서 내린 결정은\n실제보다 더 무겁게 다가와요\n\n눈을 가린 채 보이는 한 가지가\n전부라고 단정하지 마세요\n\n키워드: 자기 가둠 · 단정 · 흐린 시야',
    1, 'slide02.png')

  await contentSlide('seven-of-cups',
    'Seven of Cups', '환상에 휘둘리지 않기',
    '여러 갈래로 보이는 선택지가\n모두 진짜는 아닐 수 있어요\n\n원하는 모습으로 그려놓은 환상이\n진짜 결을 가리고 있는 시기예요\n\n키워드: 환상 · 갈림길 · 분산된 마음',
    2, 'slide03.png')

  await contentSlide('three-of-swords',
    'Three of Swords', '먼저 상처로 받아들이지 않기',
    '아직 일어나지 않은 결말을\n미리 슬픔으로 끌어오지 마세요\n\n흐릿할 때 받아들인 상처는\n실제보다 깊게 자리잡을 수 있어요\n\n키워드: 성급한 결론 · 미리 만든 상처',
    3, 'slide04.png')
