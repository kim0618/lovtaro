...
const outputDir = resolve(rootDir, 'content-output/2026-05-23_sat/carousel')
...
async function slide01() {
  ...
  if (masked) {
    ...
    <text x="540" y="1085" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="40" font-weight="300" fill="#F4F8FF" text-anchor="middle">한동안 멈춰 있던 마음에,</text>
    <text x="540" y="1140" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="40" font-weight="300" fill="#F4F8FF" text-anchor="middle">다시 사랑이 다가올 때</text>
    <text x="540" y="1205" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="40" font-weight="300" fill="#F4F8FF" text-anchor="middle">보이는 3가지 신호</text>
...
async function slide05() {
  ...
  if (masked) {
    ...
    <text x="540" y="1105" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="24" fill="rgba(210,200,250,0.65)" text-anchor="middle">신호가 보이는 날 다시 꺼내보세요</text>
    <line x1="400" y1="1140" x2="680" y2="1140" stroke="rgba(180,170,230,0.12)" stroke-width="1"/>
    <text x="540" y="1180" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="22" fill="rgba(200,190,240,0.5)" text-anchor="middle">비슷한 시기를 지나는 친구가 있다면</text>
...
async function main() {
  console.log('=== 2026-05-23 carousel 이미지 생성 ===')
  mkdirSync(outputDir, { recursive: true })

  await slide01()

  await contentSlide('two-of-cups',
    'Two of Cups', '잔잔한 연결의 신호',
    '오랜만에 떠오른 누군가의 이름\n자연스러운 인사 한 줄이 도착해요\n\n조용했던 자리에 다시\n작은 결이 흐르기 시작하는 시기예요\n\n키워드: 재연결 · 화해 · 자연스러운 흐름',
    1, 'slide02.png')

  await contentSlide('six-of-wands',
    'Six of Wands', '회복된 자신감의 신호',
    '거울 속 표정이 달라져 있어요\n예전보다 내 결을 더 단단히 들고 있어요\n\n자존을 잘 챙긴 시간은\n사랑을 끌어오는 가장 깊은 기반이에요\n\n키워드: 자존감 · 회복 · 끌어당김',
    2, 'slide03.png')

  await contentSlide('six-of-swords',
    'Six of Swords', '잔잔해진 마음의 신호',
    '한동안 일렁이던 감정이\n천천히 가라앉기 시작해요\n\n맑아진 자리에 새로운 결이\n조용히 자리를 잡으려 해요\n\n키워드: 전환 · 평온 · 새로운 결',
    3, 'slide04.png')
