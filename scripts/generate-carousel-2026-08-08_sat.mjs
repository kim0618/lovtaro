...
const outputDir = resolve(rootDir, 'content-output/2026-08-08_sat/carousel')
...
async function slide01() {
  ...
  if (masked) {
    ...
    <text x="540" y="1085" font-family="sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">다시 가까워지기 직전,</text>
    <text x="540" y="1145" font-family="sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">두 사람 사이에 보이는</text>
    <text x="540" y="1205" font-family="sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">신호 3가지</text>
...
async function main() {
  console.log('=== 2026-08-08 carousel 이미지 생성 (The Star) ===')
  mkdirSync(outputDir, { recursive: true })

  await slide01()

  await contentSlide('six-of-wands',
    'Six of Wands', '말투가 먼저 바뀌어요',
    '툭툭 끊기던 대답이\n조금씩 길어지기 시작해요\n\n내용보다 온도가 먼저\n달라지는 게 첫 신호예요\n\n키워드: 인정 · 회복 · 온도',
    1, 'slide02.png')

  await contentSlide('six-of-cups',
    'Six of Cups', '예전 이야기를 꺼내요',
    '같이 갔던 곳이나\n그때 웃었던 일을 문득 말해요\n\n지난 시간을 꺼낸다는 건\n아직 그 자리가 남아 있다는 뜻이에요\n\n키워드: 추억 · 그리움 · 회귀',
    2, 'slide03.png')

  await contentSlide('three-of-pentacles',
    'Three of Pentacles', '같이 하자는 말이 나와요',
    '보자는 말에서 끝나지 않고\n무엇을 할지가 붙기 시작해요\n\n계획에 나를 넣는 순간\n관계는 이미 방향을 튼 거예요\n\n키워드: 협력 · 계획 · 함께',
    3, 'slide04.png')
