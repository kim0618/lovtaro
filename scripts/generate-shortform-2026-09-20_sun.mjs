...
const outputDir = resolve(rootDir, 'content-output/2026-09-20_sun/insta')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'strength', imageSrc: 'public/images/cards-png/strength.png',
    nameKr: '힘', nameEn: 'Strength', keywords: '용기 · 인내 · 부드러운 힘',
    hook: ['주 초반, 서두르지 않아도', '편안함이 쌓일 수 있어요'] },
  { num: '②', slug: 'three-of-cups', imageSrc: 'public/images/mcards/cups/Three of Cups.png',
    nameKr: '컵의 3', nameEn: 'Three of Cups', keywords: '축하 · 기쁨 · 함께하는 행복',
    hook: ['주 중반, 함께 웃는', '자리가 생길 수 있어요'] },
  { num: '③', slug: 'king-of-cups', imageSrc: 'public/images/mcards/cups/King of Cups.png',
    nameKr: '컵의 킹', nameEn: 'King of Cups', keywords: '감정적 성숙 · 안정 · 이해',
    hook: ['주 후반, 속 깊은 이야기가', '오갈 수 있어요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="420" text-anchor="middle" font-family="${KO_STACK}" font-size="46" fill="#F4F8FF" letter-spacing="1" font-weight="300">다음 주, 두 사람 사이에</text>
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="50" fill="#F4F8FF" letter-spacing="2" font-weight="300">둘만 아는 이야기가 생길까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-09-20 Sunday Tarot Preview - Strength/Three of Cups/King of Cups ===')
  mkdirSync(outputDir, { recursive: true })
  await scene01()                                  // 훅 도입
  await scene02()                                  // 선택 유도
  await revealScene(CARDS[0], 431, 'scene03.png')  // 1번 공개 (The Tower)
  await revealScene(CARDS[1], 437, 'scene04.png')  // 2번 공개 (Eight of Wands)
  await revealScene(CARDS[2], 443, 'scene05.png')  // 3번 공개 (Eight of Pentacles)
