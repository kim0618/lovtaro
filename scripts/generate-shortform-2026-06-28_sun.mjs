...
const outputDir = resolve(rootDir, 'content-output/2026-06-28_sun/shortform')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'ace-of-cups', imageSrc: 'public/images/mcards/cups/Ace of Cups.png',
    nameKr: '컵의 에이스', nameEn: 'Ace of Cups', keywords: '시작 · 새 감정 · 흐름',
    hook: ['주 초반, 막혀 있던 감정이', '다시 흐르기 시작해요'] },
  { num: '②', slug: 'empress', imageSrc: 'public/images/cards-png/empress.png',
    nameKr: '여황제', nameEn: 'The Empress', keywords: '풍요 · 사랑 · 무르익음',
    hook: ['주 중반, 막혔던 마음이', '다시 풍성하게 차올라요'] },
  { num: '③', slug: 'ten-of-cups', imageSrc: 'public/images/mcards/cups/Ten of Cups.png',
    nameKr: '컵의 10', nameEn: 'Ten of Cups', keywords: '완성 · 화목 · 충만',
    hook: ['주 후반, 두 사람 사이가', '다시 환하게 이어져요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="420" text-anchor="middle" font-family="${KO_STACK}" font-size="50" fill="#F4F8FF" letter-spacing="1" font-weight="300">7월 첫 주, 막혀 있던</text>
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="56" fill="#F4F8FF" letter-spacing="2" font-weight="300">두 사람 사이가 풀릴까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-06-28 Sunday Tarot Preview - Ace of Cups/Empress/Ten of Cups ===')
  mkdirSync(outputDir, { recursive: true })
  await scene01()                                  // 훅 도입
  await scene02()                                  // 선택 유도
  await revealScene(CARDS[0], 122, 'scene03.png')  // 1번 공개 (Ace of Cups)
  await revealScene(CARDS[1], 222, 'scene04.png')  // 2번 공개 (The Empress)
  await revealScene(CARDS[2], 322, 'scene05.png')  // 3번 공개 (Ten of Cups)
