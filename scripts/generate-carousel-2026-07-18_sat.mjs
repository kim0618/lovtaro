...
const outputDir = resolve(rootDir, 'content-output/2026-07-18_sat/carousel')
...
async function slide01() {
  ...
  const img = await loadCard('tower', cW, cH)
  ...
  if (masked) {
    ...
    <text x="540" y="1085" font-family="sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">다툰 뒤에</text>
    <text x="540" y="1145" font-family="sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">절대 먼저 하면 안 되는</text>
    <text x="540" y="1205" font-family="sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">말 3가지</text>
...
async function slide05() {
  ...
  if (masked) {
    ...
    <text x="540" y="1105" font-family="sans-serif" font-size="24" fill="rgba(210,200,250,0.65)" text-anchor="middle">다툰 날, 다시 꺼내보며 마음을 가라앉혀요</text>
    <line x1="400" y1="1140" x2="680" y2="1140" stroke="rgba(180,170,230,0.12)" stroke-width="1"/>
    <text x="540" y="1180" font-family="sans-serif" font-size="22" fill="rgba(200,190,240,0.5)" text-anchor="middle">관계로 지친 친구가 있다면</text>
...
async function main() {
  console.log('=== 2026-07-18 carousel 이미지 생성 (다툰 뒤 하면 안 되는 말) ===')
  mkdirSync(outputDir, { recursive: true })

  await slide01()

  await contentSlide('page-of-swords',
    'Page of Swords', '몰아붙이는 말',
    '감정이 격해질수록\n상대를 몰아붙이게 돼요\n\n지적이 쌓일수록 대화는 멈추고\n마음의 문은 더 닫혀요\n\n키워드: 비난 · 날 선 말 · 방어',
    1, 'slide02.png')

  await contentSlide('five-of-wands',
    'Five of Wands', '이기려는 말',
    '누가 옳은지 가리려 할수록\n다툼은 신경전으로 번져요\n\n이기는 대화보다\n풀어가는 대화가 필요해요\n\n키워드: 신경전 · 경쟁 · 소모',
    2, 'slide03.png')

  await contentSlide('five-of-cups',
    'Five of Cups', '지난 일을 들추는 말',
    '이미 지나간 실망을\n다시 꺼내면 상처만 깊어져요\n\n지금 이 감정에 집중할 때\n관계는 회복을 시작해요\n\n키워드: 후회 · 미련 · 되풀이',
    3, 'slide04.png')
