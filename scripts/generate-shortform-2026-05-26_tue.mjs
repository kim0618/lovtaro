/**
 * 참여형 shortform 2026-05-26_tue (Sun/Death/Two of Wands)
 * 훅: 끝일까, / 다시 시작일까?
 */
...
const outputDir = resolve(rootDir, 'content-output/2026-05-26_tue/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(26)}

    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="60" fill="#F4F8FF" letter-spacing="4" font-weight="300">끝일까,</text>
      <text x="540" y="465" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="60" fill="#F4F8FF" letter-spacing="4" font-weight="300">다시 시작일까?</text>
    </g>
...
async function main() {
  console.log('=== 2026-05-26 참여형 shortform 이미지 생성 ===')
