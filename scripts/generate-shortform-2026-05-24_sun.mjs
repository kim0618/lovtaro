...
const outputDir = resolve(rootDir, 'content-output/2026-05-24_sun/shortform')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'ace-of-cups',     imageSrc: 'public/images/mcards/cups/Ace of Cups.png',
    nameKr: '컵의 에이스',     nameEn: 'Ace of Cups',      keywords: '새 감정 · 시작 · 마음의 문',
    hook: ['주 초반, 새 감정이', '조용히 도착할 수 있어요'] },
  { num: '②', slug: 'hanged-man',     imageSrc: 'public/images/cards-png/hanged-man.png',
    nameKr: '매달린 사람',     nameEn: 'The Hanged Man',   keywords: '멈춤 · 새 시선 · 받아들임',
    hook: ['수~목 사이, 잠시 멈추는 자리에서', '다른 결이 보일 수 있어요'] },
  { num: '③', slug: 'world',           imageSrc: 'public/images/cards-png/world.png',
    nameKr: '세계',            nameEn: 'The World',        keywords: '완성 · 결실 · 한 매듭',
    hook: ['주 후반, 한 흐름이', '매듭지어지는 결로 닿을 수 있어요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      ...
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="56" fill="#F4F8FF" letter-spacing="2" font-weight="300">멈춰 있던 흐름이 새로 시작될까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-05-24 Sunday Tarot Preview - Ace of Cups/Hanged Man/World ===')
