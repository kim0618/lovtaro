...
const outputDir = resolve(rootDir, 'content-output/2026-08-22_sat/carousel')
...
async function slide01() {
  ...
  if (masked) {
    ...
    <text x="540" y="1085" font-family="sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">연애가 늘 같은 데서</text>
    <text x="540" y="1145" font-family="sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">멈추는 사람에게</text>
    <text x="540" y="1205" font-family="sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">반복되는 패턴 3가지</text>
...
async function main() {
  console.log('=== 2026-08-22 carousel 이미지 생성 (The Emperor) ===')
  mkdirSync(outputDir, { recursive: true })

  await slide01()

  await contentSlide('nine-of-wands',
    'Nine of Wands', '먼저 방어벽부터 세워요',
    '한 번 다쳐본 사람일수록\n다가오기 전에 먼저 벽을 올려요\n\n지키려던 자리가\n가까워질 자리까지 막을 때가 있어요\n\n키워드: 경계 · 회복력 · 방어',
    1, 'slide02.png')

  await contentSlide('eight-of-cups',
    'Eight of Cups', '애매해지면 먼저 등을 돌려요',
    '확실하지 않은 자리에 남는 게 두려워\n버림받기 전에 먼저 걸어 나와요\n\n떠난 이유를 말하지 않으면\n상대는 끝난 줄도 모른 채 남아요\n\n키워드: 떠남 · 미완 · 회피',
    2, 'slide03.png')

  await contentSlide('six-of-swords',
    'Six of Swords', '정리하지 않은 채 다음으로 가요',
    '지난 관계를 덮어둔 채로\n새로운 사람 앞에 서게 돼요\n\n다 건너오지 못한 마음은\n같은 자리에서 다시 멈춰서요\n\n키워드: 전환 · 이동 · 미완의 정리',
    3, 'slide04.png')
