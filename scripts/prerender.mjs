    ...
    faq: [
      {
        ...
        answer: '연인 카드가 나왔다고 해서 상대의 마음이 반드시 열려 있다는 뜻은 아니에요. 다만 이 카드는 감정이 무르익은 상태에서 등장하는 카드라, 지금 시도해볼 타이밍이 왔다는 신호에 가까워요. 큰 고백이 부담스럽다면 가벼운 감정 표현부터 시작하는 것도 방법이에요. 선택을 미루는 것 자체가 하나의 선택이라는 걸 기억하면서요.',
      },
      {
