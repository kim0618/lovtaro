...
const outputDir = resolve(rootDir, 'content-output/2026-05-21_thu/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">이번 주, 답을 받고 싶은 사람 있다면</text>
...
async function main() {
  console.log('=== 2026-05-21 참여형 shortform 이미지 생성 (코스믹 감성) ===')
