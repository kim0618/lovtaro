...
const outputDir = resolve(rootDir, 'content-output/2026-09-06_sun/insta')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'hermit', imageSrc: 'public/images/cards-png/hermit.png',
    nameKr: '은둔자', nameEn: 'The Hermit', keywords: '내면 · 거리 · 성찰',
    hook: ['주 초반, 서로 조용해지는', '시간이 올 수 있어요'] },
  { num: '②', slug: 'knight-of-wands', imageSrc: 'public/images/mcards/wands/Knight of Wands.png',
    nameKr: '완드의 나이트', nameEn: 'Knight of Wands', keywords: '모험 · 자유 · 열정적 행동',
    hook: ['주 중반, 갑자기 속도가', '붙을 수 있어요'] },
  { num: '③', slug: 'ace-of-pentacles', imageSrc: 'public/images/mcards/pentacles/Ace of Pentacles.png',
    nameKr: '펜타클의 에이스', nameEn: 'Ace of Pentacles', keywords: '새로운 시작 · 현실적 기반 · 기회',
    hook: ['주 후반, 작지만 확실한', '시작이 놓일 수 있어요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="420" text-anchor="middle" font-family="${KO_STACK}" font-size="46" fill="#F4F8FF" letter-spacing="1" font-weight="300">다음 주, 짧던 인사가</text>
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="50" fill="#F4F8FF" letter-spacing="2" font-weight="300">안부로 길어질까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-09-06 Sunday Tarot Preview - Hermit/Knight of Wands/Ace of Pentacles ===')
  mkdirSync(outputDir, { recursive: true })
  await scene01()                                  // 훅 도입
  await scene02()                                  // 선택 유도
  await revealScene(CARDS[0], 341, 'scene03.png')  // 1번 공개 (The Tower)
  await revealScene(CARDS[1], 347, 'scene04.png')  // 2번 공개 (Eight of Wands)
  await revealScene(CARDS[2], 353, 'scene05.png')  // 3번 공개 (Eight of Pentacles)
