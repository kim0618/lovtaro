...
const outputDir = resolve(rootDir, 'content-output/2026-05-16_sat/carousel')
...
async function slide01() {
  ...
  const img = await loadCard('empress', cW, cH)
  ...
  if (masked) {
    ...
    <text x="540" y="1085" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">먼저 사랑받는 사람은,</text>
    <text x="540" y="1145" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">절대 놓치지 않는</text>
    <text x="540" y="1205" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">3가지 결</text>
...
async function slide05() {
  ...
  if (masked) {
    ...
    <text x="540" y="1105" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="24" fill="rgba(210,200,250,0.65)" text-anchor="middle">마음이 흔들릴 때 다시 꺼내보세요</text>
    <text x="540" y="1145" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="20" fill="rgba(232,212,139,0.55)" text-anchor="middle">The Empress</text>
    <line x1="400" y1="1140" x2="680" y2="1140" stroke="rgba(180,170,230,0.12)" stroke-width="1"/>
    <text x="540" y="1180" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="22" fill="rgba(200,190,240,0.5)" text-anchor="middle">비슷한 결로 흔들리는 친구가 있다면</text>
    <text x="540" y="1212" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="22" fill="rgba(200,190,240,0.5)" text-anchor="middle">조용히 공유해보세요</text>
    </svg>`
...
async function main() {
  console.log('=== 2026-05-16 sat carousel - 먼저 사랑받는 3가지 결 (Empress/QPents/9Pents/AcePents) ===')
  mkdirSync(outputDir, { recursive: true })

  await slide01()

  await contentSlide('queen-of-pentacles',
    'Queen of Pentacles', '나를 먼저 채우는 결',
    '관계 안에 들어가기 전에\n자기 일상부터 단단하게 채워요\n\n혼자 있는 시간이 충분히 풍요로운 사람은\n다가오는 마음에도 흔들리지 않는 결을 가져요\n\n키워드: 자기 풍요 · 일상 · 단단함',
    1, 'slide02.png')

  await contentSlide('nine-of-pentacles',
    'Nine of Pentacles', '혼자도 충분한 결',
    '연애가 없어도 결 자체가 흔들리지 않아요\n그 안정감이 사람을 끌어당기는 결이에요\n\n외로움을 채우려는 마음이 아니라\n나눠주고 싶은 마음에서 출발하는 결\n\n키워드: 자족 · 독립 · 여유',
    2, 'slide03.png')

  await contentSlide('ace-of-pentacles',
    'Ace of Pentacles', '자연스럽게 시작되는 결',
    '먼저 채운 결 위에서는\n새 사랑도 자연스럽게 자리잡아요\n\n억지로 끌어오는 인연이 아니라\n뿌리부터 안정된 결로 자라는 시작이에요\n\n키워드: 새로운 시작 · 안정 · 뿌리',
    3, 'slide04.png')
