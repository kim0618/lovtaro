...
const outputDir = resolve(rootDir, 'content-output/2026-05-09_sat/carousel')
...
async function slide01() {
  ...
  const img = await loadCard('high-priestess', cW, cH)
  ...
  if (masked) {
    ...
    <text x="540" y="1085" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">마음이 자꾸 흔들린다면</text>
    <text x="540" y="1145" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">지금 보이고 있는</text>
    <text x="540" y="1205" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">3가지 신호</text>
...
async function main() {
  console.log('=== 2026-05-09 sat carousel - 마음이 흔들리는 3가지 신호 (HighPriestess/9Swords/7Cups/4Swords) ===')
  mkdirSync(outputDir, { recursive: true })

  await slide01()

  await contentSlide('nine-of-swords',
    'Nine of Swords', '혼자 있을 때 자꾸 떠올라요',
    '낮에는 잘 지내는 척하다가도\n밤이 되면 떠오르는 사람이 있어요\n\n그 떠오름은 무의식이 보내는 결,\n마음 어딘가 아직 닿아 있다는 신호예요\n\n키워드: 미련 · 밤의 결 · 신호',
    1, 'slide02.png')

  await contentSlide('seven-of-cups',
    'Seven of Cups', '여러 갈래로 흔들려요',
    '어떤 날은 끝내야 할 것 같다가\n다른 날은 다시 닿고 싶어져요\n\n흩어지는 마음 자체가\n결정을 미루고 싶은 무의식의 결이에요\n\n키워드: 혼란 · 망설임 · 갈래',
    2, 'slide03.png')

  await contentSlide('four-of-swords',
    'Four of Swords', '잠시 멈춤이 필요해요',
    '답을 강제로 정하지 않아도 돼요\n카드는 잠시 쉬어가라고 말해요\n\n멈춤 안에서 결이 정리되면\n그때 진짜 답이 천천히 떠올라요\n\n키워드: 휴식 · 정리 · 회복',
    3, 'slide04.png')
