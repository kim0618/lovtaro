...
const outputDir = resolve(rootDir, 'content-output/2026-09-22_tue/insta')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(922)}

    <!-- Card area subtle glow -->
    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="46" fill="#F4F8FF" letter-spacing="3" font-weight="300">이번 주, 그 사람 프로필 사진이</text>
      <text x="540" y="455" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="46" fill="#F4F8FF" letter-spacing="3" font-weight="300">어느새 바뀌어 있을까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-09-22_tue 참여형 shortform 이미지 생성 (코스믹 감성) ===')
