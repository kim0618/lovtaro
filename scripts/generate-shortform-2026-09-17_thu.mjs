...
const outputDir = resolve(rootDir, 'content-output/2026-09-17_thu/insta')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(917)}

    <!-- Card area subtle glow -->
    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="340" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="42" fill="#F4F8FF" letter-spacing="3" font-weight="300">이름만 들어도,</text>
      <text x="540" y="415" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="42" fill="#F4F8FF" letter-spacing="3" font-weight="300">마음이 먼저 반응하는 사람</text>
      <text x="540" y="490" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="42" fill="#F4F8FF" letter-spacing="3" font-weight="300">그 사람 기준으로 하나만 골라보세요</text>
    </g>
    ...
    <text x="540" y="1640" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="30" fill="rgba(244,248,255,0.6)" letter-spacing="5" font-weight="300">직감으로 골라보세요</text>
...
async function generateScene02() {
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="910" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">직감으로 고른 번호를</text>
      <text x="540" y="985" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">댓글에 적어주세요</text>
      <text x="540" y="1100" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="34" fill="rgba(232,212,139,0.85)" letter-spacing="4" font-weight="300">해석을 댓글로 달아드릴게요</text>
    </g>
...
async function main() {
  console.log('=== 2026-09-17_thu 참여형 shortform 이미지 생성 (코스믹 감성) ===')
