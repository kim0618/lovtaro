...
const outputDir = resolve(rootDir, 'content-output/2026-08-30_sun/insta')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'tower', imageSrc: 'public/images/cards-png/tower.png',
    nameKr: '탑', nameEn: 'The Tower', keywords: '급변 · 균열 · 진실의 드러남',
    hook: ['주 초반, 미뤄둔 이야기가', '먼저 터져나올 수 있어요'] },
  { num: '②', slug: 'eight-of-wands', imageSrc: 'public/images/mcards/wands/Eight of Wands.png',
    nameKr: '완드의 8', nameEn: 'Eight of Wands', keywords: '빠른 전개 · 메시지 · 신속한 움직임',
    hook: ['주 중반, 연락이 한꺼번에', '몰려올 수 있어요'] },
  { num: '③', slug: 'eight-of-pentacles', imageSrc: 'public/images/mcards/pentacles/Eight of Pentacles.png',
    nameKr: '펜타클의 8', nameEn: 'Eight of Pentacles', keywords: '노력 · 성실함 · 꾸준한 발전',
    hook: ['주 후반, 쌓아둔 마음이', '조용히 전해질 수 있어요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="420" text-anchor="middle" font-family="${KO_STACK}" font-size="46" fill="#F4F8FF" letter-spacing="1" font-weight="300">다음 주, 못 꺼내던 그 말이</text>
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="50" fill="#F4F8FF" letter-spacing="2" font-weight="300">그 사람 입에서 나올까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-08-30 Sunday Tarot Preview - Tower/Eight of Wands/Eight of Pentacles ===')
