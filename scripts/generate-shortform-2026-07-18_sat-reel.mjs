...
const outputDir = resolve(rootDir, 'content-output/2026-07-18_sat/shortform-reel')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(38)}

    <!-- Card area subtle glow -->
    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">이번 주말, 두 사람 사이에</text>
      <text x="540" y="455" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">반가운 변화가 생길까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-07-18 토릴 참여형 shortform 이미지 생성 (코스믹 감성) ===')
