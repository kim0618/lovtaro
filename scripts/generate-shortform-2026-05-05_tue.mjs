...
const outputDir = resolve(rootDir, 'content-output/2026-05-05_tue/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="50" fill="#F4F8FF" letter-spacing="2" font-weight="300">지금 마음에 두고 있는 사람 기준으로,</text>
...
async function main() {
  console.log('=== 2026-05-05 화 참여형 #2 (그 사람과 나, 어울리는 사이?) ===')
