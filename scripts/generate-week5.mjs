/**
 * LOVTARO 인스타그램 5번째 콘텐츠 생성 (4/27~5/3)
 * 실행: node scripts/generate-week5.mjs
 *
...
const WEEK5 = [
  {
    date: '4월 27일 (월)', folder: '4월_27일__월_',
    type: 'carousel',
    theme: '이번 주 연애운',
    cards: [
      { slug: 'high-priestess', name: '여사제', nameEn: 'The High Priestess', day: '월', line: '직감이 강해지는 날\n느낌대로 행동해보세요' },
      { slug: 'judgement', name: '심판', nameEn: 'Judgement', day: '화', line: '다시 한번 기회가 오는 날\n과거의 인연이 돌아올 수 있어요' },
      { slug: 'temperance', name: '절제', nameEn: 'Temperance', day: '수', line: '균형을 찾는 날\n서두르지 않는 게 답이에요' },
      { slug: 'world', name: '세계', nameEn: 'The World', day: '목', line: '완성의 에너지가 오는 날\n하나의 단계가 마무리돼요' },
      { slug: 'star', name: '별', nameEn: 'The Star', day: '금', line: '희망이 보이는 날\n마음이 편안해지는 시간이에요' },
      { slug: 'strength', name: '힘', nameEn: 'Strength', day: '토', line: '내면의 힘이 커지는 날\n감정을 다스릴 수 있는 날이에요' },
      { slug: 'sun', name: '태양', nameEn: 'The Sun', day: '일', line: '밝은 에너지가 가득한 날\n좋은 소식이 올 수 있어요' },
    ],
    storyCard: { slug: 'high-priestess', name: '여사제', nameEn: 'The High Priestess', keywords: ['직관', '지혜', '내면'] },
    storyHook: '이번 주 연애운\n요일별로 뽑아봤어요\n오늘 피드에서 확인하세요',
  },
  {
    date: '4월 28일 (화)', folder: '4월_28일__화_',
    type: 'reel',
    reelCard: { slug: 'high-priestess', name: '여사제', nameEn: 'The High Priestess', keywords: ['직관', '지혜', '내면'] },
    reelScenes: {
      hook: '자꾸 불안한 느낌이 들어요\n근데 이유를 모르겠어요',
      hookSub: '그냥 기분 탓인 건지\n진짜 뭔가 있는 건지',
      reveal: '상대방 속마음',
      interpret: '여사제 카드가 나왔어요\n당신의 직감이 맞아요\n상대는 지금 말 못하는 게 있어요\n기다리면 스스로 말해줄 거예요',
      cta: '비슷한 느낌이 든다면\n댓글로 알려주세요',
    },
    storyCard: { slug: 'high-priestess', name: '여사제', nameEn: 'The High Priestess', keywords: ['직관', '지혜', '내면'] },
    storyHook: '불안한 직감이 들었다면\n그건 기분 탓이 아닐 수 있어요\n여사제 카드가 말해줘요',
  },
  {
    date: '4월 29일 (수)', folder: '4월_29일__수_',
    type: 'carousel-edu',
    theme: '여사제 카드가 연애에서 나왔을 때 진짜 의미',
    eduCard: { slug: 'high-priestess', name: '여사제', nameEn: 'The High Priestess' },
    slides: [
    ...
    storyCard: { slug: 'judgement', name: '심판', nameEn: 'Judgement', keywords: ['부활', '각성', '재회'] },
    storyHook: '여사제 카드의 진짜 의미\n오늘 피드에서\n자세히 알려드릴게요',
  },
  {
    date: '4월 30일 (목)', folder: '4월_30일__목_',
    type: 'reel',
    reelCard: { slug: 'judgement', name: '심판', nameEn: 'Judgement', keywords: ['부활', '각성', '재회'] },
    reelScenes: {
      hook: '끝났다고 생각한 관계가\n자꾸 떠올라요',
      hookSub: '미련인 건지\n아직 끝나지 않은 건지',
      reveal: '상대방 속마음',
      interpret: '심판 카드가 나왔어요\n이건 미련이 아니에요\n상대도 지금 후회하고 있어요\n두 번째 기회가 올 수 있어요',
      cta: '잊지 못하는 사람이 있다면\n댓글로 알려주세요',
    },
    storyCard: { slug: 'judgement', name: '심판', nameEn: 'Judgement', keywords: ['부활', '각성', '재회'] },
    storyHook: '끝났다고 생각한 인연이\n다시 찾아올 수도 있어요\n심판 카드가 말해줘요',
  },
  {
    date: '5월 1일 (금)', folder: '5월_1일__금_',
    type: 'carousel-test',
    theme: '이별 후 행동으로 알아보는 나의 타로 유형',
    testItems: [
    ...
    storyCard: { slug: 'star', name: '별', nameEn: 'The Star', keywords: ['희망', '치유', '영감'] },
    storyHook: '이별 후 나의 행동 유형은?\n오늘 피드에서 타로 유형\n테스트해보세요',
  },
  {
    date: '5월 2일 (토)', folder: '5월_2일__토_',
    type: 'reel',
    reelCard: { slug: 'world', name: '세계', nameEn: 'The World', keywords: ['완성', '성취', '여행'] },
    reelScenes: {
      hook: '이 관계를 계속 가야 할지\n끝내야 할지 모르겠어요',
      hookSub: '매일 고민만 하고 있어요\n답이 안 나와요',
      reveal: '상대방 속마음',
      interpret: '세계 카드가 나왔어요\n이 관계는 하나의 단계가\n마무리되고 있어요\n끝이 아니라 새로운 시작이에요',
      cta: '비슷한 고민이 있다면\n댓글에 남겨주세요',
    },
    storyCard: { slug: 'world', name: '세계', nameEn: 'The World', keywords: ['완성', '성취', '여행'] },
    storyHook: '끝인 줄 알았는데\n새로운 시작일 수 있어요\n세계 카드가 말해줘요',
  },
  {
    date: '5월 3일 (일)', folder: '5월_3일__일_',
    type: 'single',
    feedCard: { slug: 'star', name: '별', nameEn: 'The Star', keywords: ['희망', '치유', '영감'] },
    storyCard: { slug: 'star', name: '별', nameEn: 'The Star', keywords: ['희망', '치유', '영감'] },
    storyHook: '힘든 시간이 지나고 있어요\n별 카드가 말해줘요\n희망은 이미 오고 있어요',
  },
]
...
async function carouselDayCard(card) {
  ...
  const svg = carouselBg(`
  <text x="540" y="48" font-family="sans-serif" font-size="22" fill="rgba(77,163,255,0.6)" text-anchor="middle" letter-spacing="4">${esc(card.day)}요일</text>
...
const CAPTIONS = {
  '4월_27일__월_': {
    carousel: `이번 주(4/27~5/3) 연애운을 카드로 뽑아봤어요
...
#연애타로리딩 #오늘의타로카드 #연애고민상담 #무료타로점 #썸타로`,
    capcut: `[CapCut 편집 가이드 - 4월 28일 화]
카드: 여사제 (The High Priestess)
총 길이: 12초
...
커버: scene2.png 선택
내보내기: 1080p / 30fps`,
    story: `[스토리 업로드 가이드 - 4월 28일 화]
카드: The High Priestess - 여사제

1) story.png를 인스타 스토리에 업로드
2) 스티커 추가:
   - 링크 스티커 → lovtaro.kr
   - 이모지 슬라이더 → "요즘 직감이 자주 맞나요?" (하트)
   - 위치 → 서울
   - @lovtarot_ 멘션
3) 공유`,
    poll: `[질문박스 스토리 - 4월 28일 화]
유형: 질문 스티커

텍스트: 연애 고민 보내주세요
질문 스티커: "직감적으로 느꼈는데 맞았던 적 있어요?"
하단: 카드 뽑아서 답해드릴게요
...
- @lovtarot_ 멘션`,
  ...
  '4월_29일__수_': {
    carousel: `타로에서 "여사제" 카드가 나오면
상대가 비밀이 있다는 뜻인지 묻는 분들 많은데
...
${HASHTAGS}`,
    story: `[스토리 업로드 가이드 - 4월 29일 수]
카드: Judgement - 심판

1) story.png를 인스타 스토리에 업로드
2) 스티커 추가:
   - 링크 스티커 → lovtaro.kr
   - 설문 스티커 → "여사제 카드 = ?" → 비밀 / 직관 / 미래 예지 / 잘 모르겠어
   - 위치 → 서울
   - @lovtarot_ 멘션
3) 공유`,
    poll: `[This or That 스토리 - 4월 29일 수]
유형: 투표 2개

투표1: 연애에서 직감 vs 논리? 느낌대로 간다 vs 분석하고 움직인다
투표2: 상대 속마음? 알고 싶어 vs 모르는 게 나아
...
#연애타로리딩 #썸타로 #오늘의타로카드 #연애고민상담 #무료타로점`,
    capcut: `[CapCut 편집 가이드 - 4월 30일 목]
카드: 심판 (Judgement)
총 길이: 12초
...
음악: 인스타에서 추가 (25-30%)
커버: scene2.png`,
    story: `[스토리 업로드 가이드 - 4월 30일 목]
카드: Judgement - 심판

1) story.png를 인스타 스토리에 업로드
2) 스티커 추가:
   - 링크 스티커 → lovtaro.kr
   - 투표 스티커 → "헤어진 사람이 다시 떠오른 적 있어? 있어 vs 없어"
   - 위치 → 서울
   - @lovtarot_ 멘션
3) 공유`,
    poll: `[질문 답변 스토리 - 4월 30일 목]
유형: 28일 질문박스 답변

1) 28일 질문박스에서 온 고민 1-2개 선택
...
${HASHTAGS}`,
    story: `[스토리 업로드 가이드 - 5월 1일 금]
카드: The Star - 별

1) story.png를 인스타 스토리에 업로드
2) 스티커 추가:
   - 링크 스티커 → lovtaro.kr
   - 설문 스티커 → "나의 이별 후 행동은? A/B/C/D"
   - 위치 → 서울
   - @lovtarot_ 멘션
3) 공유`,
    poll: `[투표 스토리 - 5월 1일 금]
...
이 관계는 하나의 단계가 마무리되고 있어요
끝이 아니라 새로운 시작이에요

비슷한 고민이 있다면 댓글 남겨주세요
다음 주에 또 답해드릴게요

직접 뽑아보기 - 프로필 링크

#연애타로리딩 #오늘의타로카드 #썸타로 #타로운세 #무료타로점`,
    capcut: `[CapCut 편집 가이드 - 5월 2일 토]
카드: 세계 (The World)
총 길이: 25초 (긴 버전)
...
내보내기: 1080p / 30fps`,
    story: `[스토리 업로드 가이드 - 5월 2일 토]
카드: The World - 세계

1) story.png를 인스타 스토리에 업로드
2) 스티커 추가:
   - 링크 스티커 → lovtaro.kr
   - 이모지 슬라이더 → "관계에서 고민 중인 거 있어요?" (하트)
   - 위치 → 서울
   - @lovtarot_ 멘션
3) 공유`,
    poll: `[질문박스 스토리 - 5월 2일 토]
유형: 질문 스티커 (다음 주용)
...
async function main() {
  ...
  for (const day of WEEK5) {
    ...
    if (day.type === 'carousel') {
      ...
      const cover = await carouselCover('이번 주 연애운, 요일별로 확인하세요', '4/28 - 5/4 이번 주 연애 흐름', '저장해두고 매일 확인하는 이번 주 연애운', day.cards.map(c => c.slug))
      ...
      const combinedCta = await carouselCTACombined('sun')
    ...
    if (day.type === 'carousel-edu') {
      ...
      const cover = await carouselEduCover(day.eduCard, '여사제 카드가 나왔다면?', '비밀이 아니라 직관이에요')
      writeFileSync(resolve(cDir, 'slide01.png'), cover)
      ...
      const combinedCta = await carouselCTACombined('high-priestess',
        ['저장해두고', '이 카드가 다시 나오면 꺼내보세요'],
        ['여사제 카드가 나온 친구가 있다면', '가볍게 공유해보세요']
      )
    ...
    if (day.type === 'carousel-test') {
      ...
      const cover = await carouselCover('이별 후 나의 행동 유형은?', '유형별 타로 카드 매칭', '댓글에 A/B/C/D로 알려주세요', day.testItems.map(t => t.slug))
      writeFileSync(resolve(cDir, 'slide01.png'), cover)

      const situation = await carouselEduSlide('상황', '좋아하는 사람과\n이별한 후\n당신의 다음 행동은?', '')
    ...
    if (day.type === 'single') {
      ...
      const feedImg = await generateFeedSingle(day.feedCard, '힘든 시간은 지나가고 있어요')
  ...
  console.log(`
══════════════════════════════════════
  5번째 콘텐츠 생성 완료! (4/27~5/3)
══════════════════════════════════════

[폴더 구조]
4월_27일__월_/  캐러셀(주간운세) 9장 + 스토리 + 투표
4월_28일__화_/  릴스(여사제) 3장면 + CapCut가이드 + 스토리 + 질문박스
4월_29일__수_/  캐러셀(여사제 카드 해설) 6장 + 스토리 + This or That
4월_30일__목_/  릴스(심판) 3장면 + CapCut가이드 + 스토리 + 질문답변
5월_1일__금_/   캐러셀(이별 후 행동 유형 테스트) 7장 + 스토리 + 투표
5월_2일__토_/   릴스(세계) 3장면(긴버전) + CapCut가이드 + 스토리 + 질문박스
5월_3일__일_/   단일피드(별) + 스토리 + 다음주예고

[릴스 사용 카드 현황]
기존(10장): 황제, 전차, 죽음, 악마, 여황제, 정의, 매달린 사람, 연인, 은둔자, 탑
이번 주(3장): 여사제, 심판, 세계
누적(13장): 13/22 사용완료
남은(9장): 바보, 마법사, 교황, 힘, 운명의 수레바퀴, 절제, 별, 달, 태양
→ 3주 더 가능 (5/24까지)
  `)
}
