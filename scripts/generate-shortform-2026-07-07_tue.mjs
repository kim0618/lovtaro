/**
 * 참여형 shortform 2026-07-07 (7/7 화 참여형(위치메타포+시점))
 * 훅: 다가가고 싶은 그 사람, 지금 / 얼마나 마음을 열고 있을까?
 */
...
const outputDir = resolve(rootDir, 'content-output/2026-07-07_tue/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(707)}

    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">다가가고 싶은 그 사람, 지금</text>
      <text x="540" y="455" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="2" font-weight="300">얼마나 마음을 열고 있을까?</text>
    </g>
...
async function main() {
  console.log('=== 7/7 화 참여형(위치메타포+시점) ===')
