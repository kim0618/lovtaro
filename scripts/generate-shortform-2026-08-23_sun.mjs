...
const outputDir = resolve(rootDir, 'content-output/2026-08-23_sun/insta')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'sun', imageSrc: 'public/images/cards-png/sun.png',
    nameKr: '태양', nameEn: 'The Sun', keywords: '기쁨 · 성공 · 활력',
    hook: ['주 초반, 흐렸던 자리에', '볕이 들 수 있어요'] },
  { num: '②', slug: 'page-of-swords', imageSrc: 'public/images/mcards/swords/Page of Swords.png',
    nameKr: '소드의 페이지', nameEn: 'Page of Swords', keywords: '호기심 · 경계심 · 새로운 소식',
    hook: ['주 중반, 예상 밖의 소식이', '들어올 수 있어요'] },
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="420" text-anchor="middle" font-family="${KO_STACK}" font-size="50" fill="#F4F8FF" letter-spacing="1" font-weight="300">다음 주, 그 사람 마음에</text>
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="56" fill="#F4F8FF" letter-spacing="2" font-weight="300">볕이 들까요?</text>
    </g>
