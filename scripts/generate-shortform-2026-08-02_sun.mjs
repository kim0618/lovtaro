...
const outputDir = resolve(rootDir, 'content-output/2026-08-02_sun/insta')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'justice', imageSrc: 'public/images/cards-png/justice.png',
    nameKr: '정의', nameEn: 'Justice', keywords: '균형 · 명확함 · 결론',
    hook: ['주 초반, 흐릿하던 기준이', '또렷하게 정리돼요'] },
  { num: '②', slug: 'four-of-wands', imageSrc: 'public/images/mcards/wands/Four of Wands.png',
    nameKr: '완드의 4', nameEn: 'Four of Wands', keywords: '안정 · 자리잡음 · 편안함',
    hook: ['주 중반, 어색하던 사이에', '편한 자리가 생겨요'] },
  { num: '③', slug: 'ace-of-cups', imageSrc: 'public/images/mcards/cups/Ace of Cups.png',
    nameKr: '컵의 에이스', nameEn: 'Ace of Cups', keywords: '새 감정 · 시작 · 열림',
    hook: ['주 후반, 이름 없던 감정에', '첫 자리가 만들어져요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="420" text-anchor="middle" font-family="${KO_STACK}" font-size="52" fill="#F4F8FF" letter-spacing="1" font-weight="300">다음 주, 이름 없던 두 사람 사이에</text>
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="56" fill="#F4F8FF" letter-spacing="2" font-weight="300">답이 생길까요?</text>
    </g>
