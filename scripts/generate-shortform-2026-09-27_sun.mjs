...
const outputDir = resolve(rootDir, 'content-output/2026-09-27_sun/insta')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'high-priestess', imageSrc: 'public/images/cards-png/high-priestess.png',
    nameKr: '여사제', nameEn: 'The High Priestess', keywords: '직관 · 신비 · 내면의 지혜',
    hook: ['주 초반, 말보다 눈치가', '먼저 오갈 수 있어요'] },
  { num: '②', slug: 'five-of-wands', imageSrc: 'public/images/mcards/wands/Five of Wands.png',
    nameKr: '완드의 5', nameEn: 'Five of Wands', keywords: '경쟁 · 갈등 · 혼란',
    hook: ['주 중반, 작은 부딪힘이', '말문을 열 수 있어요'] },
  { num: '③', slug: 'six-of-cups', imageSrc: 'public/images/mcards/cups/Six of Cups.png',
    ...
    hook: ['주 후반, 예전 이야기가', '다시 꺼내질 수 있어요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="420" text-anchor="middle" font-family="${KO_STACK}" font-size="46" fill="#F4F8FF" letter-spacing="1" font-weight="300">다음 주, 두 사람 사이</text>
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="50" fill="#F4F8FF" letter-spacing="2" font-weight="300">침묵이 깨질까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-09-20 Sunday Tarot Preview - The High Priestess/Five of Wands/Six of Cups ===')
  mkdirSync(outputDir, { recursive: true })
  await scene01()                                  // 훅 도입
  await scene02()                                  // 선택 유도
  await revealScene(CARDS[0], 451, 'scene03.png')  // 1번 공개 (The Tower)
  await revealScene(CARDS[1], 457, 'scene04.png')  // 2번 공개 (Eight of Wands)
  await revealScene(CARDS[2], 463, 'scene05.png')  // 3번 공개 (Eight of Pentacles)
