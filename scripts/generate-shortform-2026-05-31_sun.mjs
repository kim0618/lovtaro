...
const outputDir = resolve(rootDir, 'content-output/2026-05-31_sun/shortform')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'strength',         imageSrc: 'public/images/cards-png/strength.png',
    nameKr: '힘',              nameEn: 'Strength',         keywords: '인내 · 다정한 단단함 · 감정 다잡기',
    hook: ['주 초반, 흔들리던 마음이', '다시 단단해질 수 있어요'] },
  { num: '②', slug: 'chariot',          imageSrc: 'public/images/cards-png/chariot.png',
    nameKr: '전차',            nameEn: 'The Chariot',      keywords: '전진 · 의지 · 승리',
    hook: ['수~목 사이, 멈춰 있던 결이', '한 걸음 앞으로 움직일 수 있어요'] },
  { num: '③', slug: 'queen-of-wands',   imageSrc: 'public/images/mcards/wands/Queen of Wands.png',
    nameKr: '완드의 여왕',     nameEn: 'Queen of Wands',   keywords: '자신감 · 카리스마 · 본래의 빛',
    hook: ['주 후반, 본래의 빛이', '자연스럽게 다시 드러날 수 있어요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      ...
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="56" fill="#F4F8FF" letter-spacing="2" font-weight="300">멈춰 있던 의지가 다시 빛을 낼까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-05-31 Sunday Tarot Preview - Strength/Chariot/Queen of Wands ===')
