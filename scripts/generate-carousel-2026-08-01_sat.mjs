...
const outputDir = resolve(rootDir, 'content-output/2026-08-01_sat/carousel')
...
async function slide01() {
  ...
  const img = await loadCard('lovers', cW, cH)
  ...
  if (masked) {
    ...
    <text x="540" y="1085" font-family="sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">연락이 뜸해졌을 때</text>
    <text x="540" y="1145" font-family="sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">관계를 되살리는 사람들의</text>
    <text x="540" y="1205" font-family="sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">행동 3가지</text>
...
async function main() {
  console.log('=== 2026-08-01 carousel 이미지 생성 (The Lovers) ===')
  mkdirSync(outputDir, { recursive: true })

  await slide01()

  await contentSlide('two-of-cups',
    'Two of Cups', '먼저 눈을 맞춰요',
    '답을 재촉하는 대신\n가벼운 안부부터 건네요\n\n상대 속도에 맞춰\n다시 마주보는 자리를 만들어요\n\n키워드: 재연결 · 마주봄 · 존중',
    1, 'slide02.png')

  await contentSlide('six-of-pentacles',
    'Six of Pentacles', '주고받는 양을 봐요',
    '한쪽만 애쓰는 관계는\n오래 버티기 어려워요\n\n내가 얼마나 주고 있는지\n또 받고 있는지 먼저 세어봐요\n\n키워드: 균형 · 배려 · 주고받음',
    2, 'slide03.png')

  await contentSlide('two-of-wands',
    'Two of Wands', '한 발 물러나 봐요',
    '연락 하나에 매달리면\n관계 전체가 안 보여요\n\n이 사이를 어디까지 가져갈지\n스스로 먼저 정해요\n\n키워드: 관망 · 계획 · 주도',
    3, 'slide04.png')
