/**
 * 참여형 shortform 2026-07-04 (7/4 토릴 참여형(엔진: 짝사랑 한정))
 * 훅: 마음은 있는데 / 먼저 다가가지 못한 사람
 */
...
const outputDir = resolve(rootDir, 'content-output/2026-07-04_sat/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(704)}

    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">마음은 있는데</text>
      <text x="540" y="455" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">먼저 다가가지 못한 사람</text>
    </g>
...
async function main() {
  console.log('=== 7/4 토릴 참여형(엔진: 짝사랑 한정) ===')
