...
const outputDir = resolve(rootDir, 'content-output/2026-09-12_sat/insta')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(1206)}

    <!-- Card area subtle glow -->
    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="340" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="42" fill="#F4F8FF" letter-spacing="3" font-weight="300">주말 저녁, 유난히 허전할 때</text>
      <text x="540" y="415" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="42" fill="#F4F8FF" letter-spacing="3" font-weight="300">머릿속에 떠오르는 사람</text>
