...
const outputDir = resolve(rootDir, 'content-output/2026-06-07_sun/shortform')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'sun',              imageSrc: 'public/images/cards-png/sun.png',
    nameKr: '태양',            nameEn: 'The Sun',          keywords: '기쁨 · 밝아짐 · 활력',
    hook: ['주 초반, 흐렸던 기분이', '환하게 풀릴 수 있어요'] },
  { num: '②', slug: 'knight-of-wands',  imageSrc: 'public/images/mcards/wands/Knight of Wands.png',
    nameKr: '완드의 나이트',   nameEn: 'Knight of Wands',  keywords: '열정 · 빠른 행동 · 적극성',
    hook: ['주 중반, 멈춰 있던 마음이', '빠르게 먼저 다가올 수 있어요'] },
  { num: '③', slug: 'ten-of-pentacles', imageSrc: 'public/images/mcards/pentacles/Ten of Pentacles.png',
    nameKr: '펜타클의 10',     nameEn: 'Ten of Pentacles', keywords: '안정 · 함께 쌓은 것 · 오래가는 사랑',
    hook: ['주 후반, 두 사람의 결이', '더 단단하게 자리잡을 수 있어요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      ...
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="56" fill="#F4F8FF" letter-spacing="2" font-weight="300">망설이던 그 사람이 먼저 다가올까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-06-07 Sunday Tarot Preview - Sun/Knight of Wands/Ten of Pentacles ===')
  mkdirSync(outputDir, { recursive: true })
  await scene01()                                  // 훅 도입
  await scene02()                                  // 선택 유도
  await revealScene(CARDS[0], 101, 'scene03.png')  // 1번 공개 (The Sun)
  await revealScene(CARDS[1], 202, 'scene04.png')  // 2번 공개 (Knight of Wands)
  await revealScene(CARDS[2], 303, 'scene05.png')  // 3번 공개 (Ten of Pentacles)
