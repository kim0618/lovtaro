...
const outputDir = resolve(rootDir, 'content-output/2026-06-13_sat/carousel')

const W = 1080, H = 1350

const PORTRAIT_OVERRIDE = {
  'five-of-pentacles': 'public/images/mcards/pentacles/Five of Pentacles.png',
  'ten-of-swords': 'public/images/mcards/swords/Ten of Swords.png',
  'five-of-wands': 'public/images/mcards/wands/Five of Wands.png',
}
...
async function slide01() {
  ...
  if (masked) {
    ...
    <text x="540" y="1085" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">연애가 늘 같은 곳에서</text>
    <text x="540" y="1145" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">멈추는 사람에게</text>
    <text x="540" y="1205" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">반복되는 3가지 패턴</text>
...
async function main() {
  console.log('=== 2026-06-13 carousel (The Devil) 이미지 생성 ===')
  mkdirSync(outputDir, { recursive: true })

  await slide01()

  await contentSlide('five-of-pentacles',
    'Five of Pentacles', '같은 결핍을 또 채우려 할 때',
    '마음이 허전할 때마다\n그 빈자리를 같은 방식으로 채우려 할 때\n\n채워지지 않는 결핍이\n같은 연애를 다시 부르고 있어요\n\n키워드: 결핍 · 불안 · 반복',
    1, 'slide02.png')

  await contentSlide('ten-of-swords',
    'Ten of Swords', '같은 방식으로 끝맺을 때',
    '늘 비슷한 장면에서\n관계가 똑같이 끝나버릴 때\n\n그 마무리의 방식이\n다음 연애에도 그대로 따라와요\n\n키워드: 같은 결말 · 상처 · 매듭',
    2, 'slide03.png')

  await contentSlide('five-of-wands',
    'Five of Wands', '같은 갈등을 되풀이할 때',
    '사소한 데서 부딪히고\n같은 자리에서 또 어긋날 때\n\n반복되는 그 갈등이\n관계를 늘 같은 곳에 멈춰 세워요\n\n키워드: 충돌 · 소모 · 어긋남',
    3, 'slide04.png')
