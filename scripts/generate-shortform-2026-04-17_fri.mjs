/**
 * 2026-04-17 금요일 기존형 shortform 이미지 생성 (유튜브 쇼츠용)
 * - scene01: 질문 훅 + 카드 뒷면
 * - scene02: Knight of Cups 카드 공개
 * - scene03: 해석 + CTA
 *
...
async function generateScene01() {
  ...
  <g filter="url(#textGlow)">
    <text x="540" y="360" text-anchor="middle" font-family="sans-serif" font-size="54" fill="#f0e6cc" letter-spacing="2" opacity="0.95" font-weight="500">읽씹했던 그 사람,</text>
    <text x="540" y="440" text-anchor="middle" font-family="sans-serif" font-size="54" fill="#f0e6cc" letter-spacing="2" opacity="0.95" font-weight="500">다시 연락이 올까?</text>
  </g>
...
async function generateScene02() {
  ...
  const cardImg = await loadCard('judgement', cardW, cardH)
  if (!cardImg) { console.error('❌ judgement.png 없음'); return }
  ...
  <g filter="url(#textGlow)">
    <text x="540" y="280" text-anchor="middle" font-family="sans-serif" font-size="52" fill="#f0e6cc" letter-spacing="4" font-weight="500" opacity="0.95">심판</text>
    <text x="540" y="330" text-anchor="middle" font-family="sans-serif" font-size="18" fill="rgba(200,190,240,0.45)" letter-spacing="6" font-weight="300">Judgement</text>
  </g>
  <g filter="url(#textGlow)">
    <text x="540" y="${cardTop + cardH + 80}" text-anchor="middle" font-family="sans-serif" font-size="30" fill="rgba(200,180,140,0.6)" letter-spacing="6">부활 · 재연결 · 각성</text>
  </g>
</svg>`
...
async function generateScene03() {
  ...
  <g filter="url(#textGlow)">
    <text x="540" y="${textStartY}" text-anchor="middle" font-family="sans-serif" font-size="48" fill="#f0e6cc" letter-spacing="1" font-weight="500" opacity="0.95">"끝난 줄 알았던 연락이</text>
    <text x="540" y="${textStartY + 68}" text-anchor="middle" font-family="sans-serif" font-size="48" fill="#f0e6cc" letter-spacing="1" font-weight="500" opacity="0.95">다시 돌아올 수 있어요."</text>
  </g>
  <text x="540" y="${textStartY + 250}" text-anchor="middle" font-family="sans-serif" font-size="28" fill="#c9a84c" opacity="0.5" letter-spacing="2">더 자세한 흐름은 프로필 링크에서</text>
</svg>`
...
async function main() {
  console.log('=== 2026-04-17 shortform 이미지 생성 ===')
