...
const WEEK = [
  {
    date: '2026-00-00_mon', type: 'pick', seed: 1,
    hook: ['훅 1줄', '훅 2줄'],          // insta scene01로 교체되므로 폴백용
    cards: [
      {
        no: 1, numGlyph: '\u2460', file: 'cards-png/{slug}.png',
        nameKo: '카드명', nameEn: 'Card Name', keywords: '키워드 · 키워드 · 키워드',
        reveal: ['리빌 문구 1줄', '리빌 문구 2줄'],
        pages: [
          ['그 사람의 속마음', ['1', '2', '3', '4', '5', '6']],
          ['러브타로의 조언', ['1', '2', '3', '4', '5', '6']],
        ],
      },
      // no:2, no:3 동일 구조
    ],
  ...
  {
    date: '2026-00-00_wed', type: 'single', seed: 2,
    hook: ['훅 1줄', '훅 2줄'],
    cards: [
      {
        no: 1, numGlyph: '', file: 'mcards/{suit}/{Name}.png',
        nameKo: '카드명', nameEn: 'Card Name', keywords: '키워드 · 키워드 · 키워드',
        reveal: ['리빌 문구 1줄', '리빌 문구 2줄'],
        pages: [
          ['지금 내 마음', ['1', '2', '3', '4', '5', '6']],
