/**
 * 참여형 shortform 2026-07-02 (7/2 목 참여형(양자택일 강페어))
 * 훅: 다가올까, / 멀어질까?
 */
...
const outputDir = resolve(rootDir, 'content-output/2026-07-02_thu/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(702)}

    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">다가올까,</text>
      <text x="540" y="455" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">멀어질까?</text>
    </g>
...
async function main() {
  console.log('=== 7/2 목 참여형(양자택일 강페어) ===')
