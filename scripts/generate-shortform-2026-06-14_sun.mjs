...
const outputDir = resolve(rootDir, 'content-output/2026-06-14_sun/shortform')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'empress',              imageSrc: 'public/images/cards-png/empress.png',
    nameKr: '여황제',            nameEn: 'The Empress',          keywords: '다정함 · 포용 · 피어남',
    hook: ['주 초반, 닫혀 있던 마음이', '부드럽게 풀리기 시작해요'] },
  { num: '②', slug: 'ace-of-wands',  imageSrc: 'public/images/mcards/wands/Ace of Wands.png',
    nameKr: '완드의 에이스',   nameEn: 'Ace of Wands',  keywords: '새 불씨 · 시작 · 끌림',
    hook: ['주 중반, 멈춰 있던 마음에', '새로운 불씨가 켜질 수 있어요'] },
  { num: '③', slug: 'ace-of-pentacles', imageSrc: 'public/images/mcards/pentacles/Ace of Pentacles.png',
    nameKr: '펜타클의 에이스',     nameEn: 'Ace of Pentacles', keywords: '새 토대 · 현실적 시작 · 안정',
    hook: ['주 후반, 그 마음이 단단한', '자리로 새로 열릴 수 있어요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="420" text-anchor="middle" font-family="${KO_STACK}" font-size="58" fill="#F4F8FF" letter-spacing="2" font-weight="300">다음 주, 닫혀 있던</text>
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="56" fill="#F4F8FF" letter-spacing="2" font-weight="300">그 사람 마음이 열릴까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-06-14 Sunday Tarot Preview - Empress/Ace of Wands/Ace of Pentacles ===')
  mkdirSync(outputDir, { recursive: true })
  await scene01()                                  // 훅 도입
  await scene02()                                  // 선택 유도
  await revealScene(CARDS[0], 114, 'scene03.png')  // 1번 공개 (The Sun)
  await revealScene(CARDS[1], 214, 'scene04.png')  // 2번 공개 (Knight of Wands)
  await revealScene(CARDS[2], 314, 'scene05.png')  // 3번 공개 (Ten of Pentacles)
