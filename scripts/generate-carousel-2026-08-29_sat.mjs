...
async function contentSlide(cardSlug, nameEn, subtitle, bodyText, index, filename) {
  ...
  <text x="1030" y="50" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="18" fill="rgba(180,170,230,0.5)" text-anchor="end">${index}/3</text>
...
async function slide05() {
  ...
  if (masked) {
    ...
    <text x="540" y="1105" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="24" fill="rgba(210,200,250,0.65)" text-anchor="middle">마음이 약해질 때 다시 꺼내보세요</text>
    <line x1="400" y1="1140" x2="680" y2="1140" stroke="rgba(180,170,230,0.12)" stroke-width="1"/>
    <text x="540" y="1180" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="22" fill="rgba(200,190,240,0.5)" text-anchor="middle">힘들어하는 친구가 있다면</text>
