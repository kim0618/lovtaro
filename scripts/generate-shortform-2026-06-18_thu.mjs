...
const outputDir = resolve(rootDir, 'content-output/2026-06-18_thu/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(118)}

    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" fill="#F4F8FF" letter-spacing="2" font-weight="300">하루에도 몇 번씩 생각나는 사람,</text>
      <text x="540" y="455" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">지금 하나만 골라보세요</text>
    </g>
...
async function main() {
  console.log('=== 2026-06-08 참여형 릴스 shortform 이미지 생성 ===')
