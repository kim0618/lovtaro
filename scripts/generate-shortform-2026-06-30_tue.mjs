/**
 * 참여형 shortform 2026-06-30 (6/30 화 참여형(시점+변화동사))
 * 훅: 이번 주, 서먹하던 두 사람 / 분위기가 누그러질까요?
 */
...
const outputDir = resolve(rootDir, 'content-output/2026-06-30_tue/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(630)}

    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">이번 주, 서먹하던 두 사람</text>
      <text x="540" y="455" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="48" fill="#F4F8FF" letter-spacing="3" font-weight="300">분위기가 누그러질까요?</text>
    </g>
...
async function main() {
  console.log('=== 6/30 화 참여형(시점+변화동사) ===')
