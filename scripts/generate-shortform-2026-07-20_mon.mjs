...
const outputDir = resolve(rootDir, 'content-output/2026-07-20_mon/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    ${participationBody(20)}

    <!-- Card area subtle glow -->
    <ellipse cx="540" cy="${cardY}" rx="500" ry="380" fill="url(#cardAreaGlow)" filter="url(#glowBlur)"/>

    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" fill="#F4F8FF" letter-spacing="2" font-weight="300">며칠째 안 지워지는 그 사람 기준으로,</text>
...
async function main() {
  console.log('=== 2026-07-16 참여형 shortform 이미지 생성 (코스믹 감성) ===')
