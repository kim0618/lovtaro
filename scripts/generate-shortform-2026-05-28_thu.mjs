/**
 * 참여형 shortform 2026-05-28_thu (Devil / Four of Wands / Six of Pentacles)
 * 훅: 잊으려 해도 못 잊는 사람 기준으로, / 하나만 골라보세요
 */
...
const outputDir = resolve(rootDir, 'content-output/2026-05-28_thu/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="46" fill="#F4F8FF" letter-spacing="3" font-weight="300">잊으려 해도 못 잊는 사람 기준으로,</text>
...
async function main() {
  console.log('=== 2026-05-28 참여형 shortform 이미지 생성 ===')
