...
const outputDir = resolve(rootDir, 'content-output/2026-04-28_tue/shortform')
const W = 1080, H = 1920
...
async function generateScene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="380" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="50" fill="#F4F8FF" letter-spacing="2" font-weight="300">그 사람, 다시 연락할까요?</text>
      <text x="540" y="460" text-anchor="middle" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" fill="rgba(232,212,139,0.85)" letter-spacing="3" font-weight="300">직감으로 하나만 골라보세요</text>
    </g>
...
async function main() {
  console.log('=== 2026-04-28 화 참여형 #2 (다시 연락 올지) ===')
