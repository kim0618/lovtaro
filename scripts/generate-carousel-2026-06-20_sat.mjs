/**
 * carousel 2026-06-06_sat (Wheel of Fortune 커버)
 * 훅: 연애가 늘 같은 곳에서 / 멈추는 사람에게 3가지 결
 * 본문: Eight of Cups, Two of Wands, Six of Swords
 */
...
const outputDir = resolve(rootDir, 'content-output/2026-06-20_sat/carousel')

const W = 1080, H = 1350

const PORTRAIT_OVERRIDE = {
  'three-of-pentacles': 'public/images/mcards/pentacles/Three of Pentacles.png',
  'king-of-cups': 'public/images/mcards/cups/King of Cups.png',
  'king-of-pentacles': 'public/images/mcards/pentacles/King of Pentacles.png',
}
...
async function slide01() {
  ...
  const img = await loadCard('emperor', cW, cH)
  ...
  if (masked) {
    ...
    <text x="540" y="1085" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">마음이 진심일 때만</text>
    <text x="540" y="1145" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">무심코 새어 나오는</text>
    <text x="540" y="1205" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">행동 3가지</text>
...
async function main() {
  console.log('=== 2026-06-20 carousel (The Emperor) 이미지 생성 ===')
  mkdirSync(outputDir, { recursive: true })

  await slide01()

  await contentSlide('three-of-pentacles',
    'Three of Pentacles', '미래에 나를 그려 넣을 때',
    '다음 주, 다음 달, 그 다음을\n이야기할 때 나를 함께 넣어요\n\n혼자만의 계획이 아니라\n같이 만들 그림을 그리기 시작해요\n\n키워드: 약속 · 함께 · 미래',
    1, 'slide02.png')

  await contentSlide('king-of-cups',
    'King of Cups', '내 감정을 끝까지 들어줄 때',
    '기분이 가라앉은 날에도\n끝까지 차분하게 들어줘요\n\n감정을 떠넘기지 않고\n받아주는 그 태도가 진심의 신호예요\n\n키워드: 안정 · 배려 · 책임',
    2, 'slide03.png')

  await contentSlide('king-of-pentacles',
    'King of Pentacles', '변함없이 곁을 지킬 때',
    '설렘이 가라앉은 뒤에도\n흔들림 없이 같은 자리에 있어요\n\n말보다 꾸준함으로\n오래 머물 마음을 보여줘요\n\n키워드: 한결같음 · 신뢰 · 든든함',
    3, 'slide04.png')
