...
const outputDir = resolve(rootDir, 'content-output/2026-06-27_sat/carousel')
...
async function slide01() {
  ...
  if (masked) {
    ...
    <text x="540" y="1085" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">그 사람 마음이 식어갈 때</text>
    <text x="540" y="1145" font-family="'Noto Sans KR','Apple SD Gothic Neo',NanumSquare,sans-serif" font-size="44" font-weight="300" fill="#F4F8FF" text-anchor="middle">나도 모르게 하는</text>
...
async function main() {
  console.log('=== 2026-06-27 carousel (The Moon 커버) 이미지 생성 ===')
  mkdirSync(outputDir, { recursive: true })

  await slide01()

  await contentSlide('knight-of-swords',
    'Knight of Swords', '불안에 다그치게 될 때',
    '왜 식었냐고 바로 묻고 싶어져요\n답을 재촉하며 몰아붙이게 돼요\n\n그럴수록 상대는 더 닫혀버려요\n급한 마음이 오히려 거리를 만들어요\n\n키워드: 조급 · 추궁 · 역효과',
    1, 'slide02.png')

  await contentSlide('eight-of-swords',
    'Eight of Swords', '혼자 최악을 그릴 때',
    '아직 아무 일도 없는데\n끝을 먼저 상상하게 돼요\n\n불안이 만든 생각에 갇혀서\n있는 그대로를 못 보게 돼요\n\n키워드: 불안 · 단정 · 자기검열',
    2, 'slide03.png')

  await contentSlide('five-of-cups',
    'Five of Cups', '미리 슬퍼하고 매달릴 때',
    '아직 남아 있는 것보다\n잃은 것에만 눈이 가요\n\n끝난 듯 굴면 정말 끝으로 가요\n남은 가능성부터 다시 봐야 해요\n\n키워드: 후회 · 집착 · 놓침',
    3, 'slide04.png')
