...
const outputDir = resolve(rootDir, 'content-output/2026-08-16_sun/insta')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'hanged-man', imageSrc: 'public/images/cards-png/hanged-man.png',
    nameKr: '매달린 사람', nameEn: 'The Hanged Man', keywords: '멈춤 · 전환 · 다른 시선',
    hook: ['주 초반, 잠시 멈춘 자리에서', '보이는 게 달라져요'] },
  { num: '②', slug: 'seven-of-cups', imageSrc: 'public/images/mcards/cups/Seven of Cups.png',
    nameKr: '컵의 7', nameEn: 'Seven of Cups', keywords: '환상 · 선택 · 혼란',
    hook: ['주 중반, 마음이 여러 갈래로', '흔들릴 수 있어요'] },
  { num: '③', slug: 'king-of-pentacles', imageSrc: 'public/images/mcards/pentacles/King of Pentacles.png',
    nameKr: '펜타클의 킹', nameEn: 'King of Pentacles', keywords: '안정 · 신뢰 · 든든함',
    hook: ['주 후반, 흔들리던 자리에', '단단함이 들어서요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="420" text-anchor="middle" font-family="${KO_STACK}" font-size="50" fill="#F4F8FF" letter-spacing="1" font-weight="300">다음 주, 두 사람 사이</text>
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="56" fill="#F4F8FF" letter-spacing="2" font-weight="300">공기가 달라질까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-08-02 Sunday Tarot Preview - Justice/Four of Wands/Ace of Cups ===')
  mkdirSync(outputDir, { recursive: true })
  await scene01()                                  // 훅 도입
  await scene02()                                  // 선택 유도
  await revealScene(CARDS[0], 131, 'scene03.png')  // 1번 공개 (Temperance)
  await revealScene(CARDS[1], 231, 'scene04.png')  // 2번 공개 (Knight of Wands)
  await revealScene(CARDS[2], 331, 'scene05.png')  // 3번 공개 (King of Swords)
