/**
 * 2026-04-20 월요일 story 이미지 생성 (마이너 아르카나)
 * - story01: Ten of Cups + "함께 쌓여가는 따뜻한 시간"
 * - 카드 경로: public/images/mcards/cups/Ten of Cups.png
 *
 * 실행: node scripts/generate-story-2026-04-20_mon.mjs
 */
