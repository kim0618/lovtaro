...
const outputDir = resolve(rootDir, 'content-output/2026-06-21_sun/shortform')
const W = 1080, H = 1920
...
const CARDS = [
  { num: '①', slug: 'star',                 imageSrc: 'public/images/cards-png/star.png',
    nameKr: '별',                nameEn: 'The Star',             keywords: '희망 · 치유 · 온기',
    hook: ['주 초반, 식었던 자리에', '작은 온기가 다시 스며요'] },
  { num: '②', slug: 'two-of-cups',  imageSrc: 'public/images/mcards/cups/Two of Cups.png',
    nameKr: '컵의 2',          nameEn: 'Two of Cups',   keywords: '연결 · 마주봄 · 회복',
    hook: ['주 중반, 멀어졌던 두 마음이', '다시 마주 볼 수 있어요'] },
  { num: '③', slug: 'queen-of-cups', imageSrc: 'public/images/mcards/cups/Queen of Cups.png',
    nameKr: '컵의 여왕',     nameEn: 'Queen of Cups', keywords: '공감 · 다정함 · 먼저 다가옴',
    hook: ['주 후반, 따뜻한 마음이', '먼저 나에게 다가올 수 있어요'] },
]
...
async function scene01() {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}">
    ...
    <g filter="url(#softGlow)">
      <text x="540" y="420" text-anchor="middle" font-family="${KO_STACK}" font-size="50" fill="#F4F8FF" letter-spacing="1" font-weight="300">다음 주, 식어가던 그 사람 마음이</text>
      <text x="540" y="505" text-anchor="middle" font-family="${KO_STACK}" font-size="56" fill="#F4F8FF" letter-spacing="2" font-weight="300">다시 나를 향할까요?</text>
    </g>
...
async function main() {
  console.log('=== 2026-06-21 Sunday Tarot Preview - Star/Two of Cups/Queen of Cups ===')
