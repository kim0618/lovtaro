...
| 스킬 | 주기 | 비고 |
|---|---|---|
| `/lovtaro-dream` | **주 4편 - 화·수·금·토만** (하드 캡, 2026-09-16 시작) | 수요 실측 최상위 레이어(9/7 웹문서 TOP30 중 27개). 연애 직결 주제가 소진돼 2026-09-15에 "매일 1편"을 폐기하고, 네이버 자동완성 실측 큐(범용 대형 10편)로 전환. 월·목·일은 손질 슬롯(저CTR 메타·T 미달 보강). 상세는 `.claude/dreams-queue.md` 운영 원칙 |
