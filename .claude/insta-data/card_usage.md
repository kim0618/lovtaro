...
- **1·2·3 참여형 메이저 메인**: 마법사·황제(월 7/27), 태양(화 7/28), 여황제(목 7/30), 달(토릴 8/1)
- **1·2·3 참여형 마이너 메인**: 펜타클의 8(월), 완드의 8·컵의 페이지(화), 소드의 2·완드의 에이스(목), 컵의 나이트·펜타클의 에이스(토릴)
- **수·금 소개형 마이너 메인**: ~~완드의 킹(수 7/29)~~ **미발행·사이클 미소진**(릴스·유튜브 모두 사용 불가, 2026-07-29 사용자 판정 → 재사용 가능), 펜타클의 7(금 7/31)
- **토 캐러셀 커버 (메이저)**: 연인(The Lovers)
