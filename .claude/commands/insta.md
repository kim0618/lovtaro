...
> ⚠️ **미발행 릴스 재활용 메모 (2026-07-14 사용자 지시)**: 2026-07-12·07-13·07-25에 준비됐으나 시간이 없어 **발행하지 못한 릴스(숏폼)** 가 있음. 콘텐츠는 살아있으니 다음 실행 시 새로 만들지 말고 해당 미발행 릴스를 **재활용**해 슬롯을 채운다. `content-output/`의 2026-07-12·07-13·07-25 폴더에서 릴스 확인. **재활용 완료 후 이 메모 삭제**.
...
> 사용자가 훅을 OK 하거나 수정 방향을 주면 그때 생성 시작. (훅만 게이트 - 이후 이미지/카피 생성은 기존대로 승인 대기 없이 진행)
...
4. **짧은 CTA 섹션 내부 라인 글루** - `[인스타 첫 댓글]`, `[유튜브 고정 댓글]`, `[틱톡 첫 댓글]`의 2~3줄은 `⠀` 없이 붙여 작성

**Why**: Windows 메모장 복붙 사용성 + IG/유튜브/틱톡 캡션 단락 보존 양립.
