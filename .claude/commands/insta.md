...
**검증된 강한 훅 vs 약한 훅 (2026-05-08 갱신, 풀 데이터는 `project_lovtaro_hook_history.md` 참고)**

| 도달 | 훅 | 패턴 분석 |
|---|---|---|
| 10,000 | 지금 마음에 두고 있는 사람 기준으로, 하나만 골라보세요 | 상황 한정 + 선택 유도 (질문 없이도 강함) ✅ |
| 7,886 | 그 사람 마음은 지금 어디쯤 와 있을까? | 위치 메타포(어디쯤) + 시점(지금) ✅ |
| 5,773 | 다음 주, 둘 사이의 흐름이 달라질까요? | 시점(다음 주) + 변화 동사(달라질) ✅ |
| 2,615 | 이번 주, 그 사람에게 변화가 있을까? | 시점(이번 주) + 변화 명사 ✅ |
| 1,033 | 호감일까 무관심일까 (Devil 캐러셀) | 양자택일 + 강한 카드 비주얼 시너지 ✅ |
| 646 | 그 사람도 나를 좋아하고 있을까? | yes/no 단순 질문 ⚠️ |
| 562 | 이 사람과 나, 정말 운명일까? | 추상어(운명) + yes/no ❌ |
| 431 | 호감일까 무관심일까 (Empress) | 동일 훅이 비주얼 약하면 1/2 ⚠️ |
